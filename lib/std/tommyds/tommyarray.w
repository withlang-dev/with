...
pub unsafe fn tommy_array_grow(__param_array: *mut tommy_array_struct, __param_count: c_ulonglong) -> Unit {
    ...
    while ((if __param_count > (*__param_array).bucket_max: 1 else: 0) != 0) {
        ...
        (__local_segment = (((with_alloc_zeroed((((*__param_array).bucket_max as c_ulong) as i64), ((sizeof[usize]() as c_ulong) as i64)) as *mut c_void) as *mut *mut c_void)))

        ((*__param_array).bucket[(*__param_array).bucket_bit] = (((&raw const (__local_segment[(0 - ((*__param_array).bucket_max as c_long))]) as *const *mut c_void) as *mut *mut c_void)))
...
pub unsafe fn tommy_array_ref(__param_array: *mut tommy_array_struct, __param_pos: c_ulonglong) -> *mut *mut c_void {
    ...
    return (((&raw const ((*__param_array).bucket[__local_bsr][__param_pos]) as *const *mut c_void) as *mut *mut c_void))
...
pub unsafe fn tommy_array_get(__param_array: *mut tommy_array_struct, __param_pos: c_ulonglong) -> *mut c_void {
    return (*(tommy_array_ref(__param_array, __param_pos)))
