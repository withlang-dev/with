...
pub unsafe fn arraylist_free(__param_arraylist: *mut _ArrayList) -> Unit {
    if ((if __param_arraylist != null: 1 else: 0) != 0) {
        with_free((((unsafe *__param_arraylist).data as *mut c_void) as *mut u8))
...
unsafe fn arraylist_enlarge(__param_arraylist: *mut _ArrayList) -> c_int {
    ...
    (__local_data = (((with_realloc((((unsafe *__param_arraylist).data as *mut c_void) as *mut u8), (0 as i64), ((((sizeof[usize]() as c_ulong) *% (__local_newsize as c_ulong)) as c_ulong) as i64)) as *mut c_void) as *mut *mut c_void)))
