...
pub unsafe fn binary_heap_insert(__param_heap: *mut _BinaryHeap, __param_value: *mut c_void) -> c_int {
    ...
    if ((if (*__param_heap).num_values >= (*__param_heap).alloced_size: 1 else: 0) != 0) {
        ...
        (__local_new_values = (((with_realloc((((*__param_heap).values as *mut c_void) as *mut u8), (0 as i64), ((((sizeof[usize]() as c_ulong) *% (__local_new_size as c_ulong)) as c_ulong) as i64)) as *mut c_void) as *mut *mut c_void)))
