...
pub unsafe fn trie_insert(__param_trie: *mut _Trie, __param_key: *mut i8, __param_value: *mut c_void) -> c_int {
    ...
    (__local_node = trie_find_end(__param_trie, (__param_key as *mut c_char)))

    var __ci_expr_logic_0: c_int = 0

    if ((if __local_node != null: 1 else: 0) != 0) {
        (__ci_expr_logic_0 = (if (if not (trie_value_is_null(((&raw const (unsafe *__local_node).data as *const *mut c_void) as *mut *mut c_void)) != 0): 1 else: 0) != 0: 1 else: 0))
    }

    if (__ci_expr_logic_0 != 0) {
        ((unsafe *__local_node).data = __param_value)
    ...
    (__local_rover = (((&raw const (unsafe *__param_trie).root_node as *const *mut _TrieNode) as *mut *mut _TrieNode)))
    ...
    while true {
        ...
        if ((if __local_node == null: 1 else: 0) != 0) {
            ...
            ((unsafe *__local_node).data = trie_null_value)
        ...
        (__local_c = ((((unsafe *__local_p) as u8) as c_int)))
        ...
        (__local_rover = (((&raw const (unsafe *__local_node).next[__local_c] as *const *mut _TrieNode) as *mut *mut _TrieNode)))
...
pub unsafe fn trie_insert_binary(__param_trie: *mut _Trie, __param_key: *mut u8, __param_key_length: c_int, __param_value: *mut c_void) -> c_int {
    ...
    while true {
        ...
        (__local_c = (((unsafe __param_key[__local_p]) as c_int)))
...
pub unsafe fn trie_remove(__param_trie: *mut _Trie, __param_key: *mut i8) -> c_int {
    ...
    (__local_node = (unsafe *__param_trie).root_node)

    (__local_last_next_ptr = (((&raw const (unsafe *__param_trie).root_node as *const *mut _TrieNode) as *mut *mut _TrieNode)))
    ...
    while true {
        ...
        (__local_next = (unsafe *__local_node).next[__local_c])
        ...
        if ((if __local_last_next_ptr != null: 1 else: 0) != 0) {
            (__local_last_next_ptr = (((&raw const (unsafe *__local_node).next[__local_c] as *const *mut _TrieNode) as *mut *mut _TrieNode)))
...
pub unsafe fn trie_num_entries(__param_trie: *mut _Trie) -> c_uint {
    if ((if (unsafe *__param_trie).root_node == null: 1 else: 0) != 0) {
        return 0

    }
    return (unsafe *(unsafe *__param_trie).root_node).use_count
...
unsafe fn free_node_recursive(__param_node: *mut _TrieNode) -> Unit {
    ...
    while ((if __local_i < 256: 1 else: 0) != 0) {
        free_node_recursive((unsafe *__param_node).next[__local_i])
...
unsafe fn trie_find_end(__param_trie: *mut _Trie, __param_key: *mut i8) -> *mut _TrieNode {
    ...
    while ((if (unsafe *__local_p) != 0: 1 else: 0) != 0) {
        ...
        (__local_node = (unsafe *__local_node).next[((unsafe *__local_p) as u8)])
...
unsafe fn trie_find_end_binary(__param_trie: *mut _Trie, __param_key: *mut u8, __param_key_length: c_int) -> *mut _TrieNode {
    ...
    while ((if __local_j < __param_key_length: 1 else: 0) != 0) {
        ...
        (__local_c = (((unsafe __param_key[__local_j]) as c_int)))

        (__local_node = (unsafe *__local_node).next[__local_c])
...
unsafe fn trie_insert_rollback(__param_trie: *mut _Trie, __param_key: *mut u8) -> Unit {
    ...
    (__local_prev_ptr = (((&raw const (unsafe *__param_trie).root_node as *const *mut _TrieNode) as *mut *mut _TrieNode)))

    (__local_p = __param_key)

    while ((if __local_node != null: 1 else: 0) != 0) {
        (__local_next_prev_ptr = (((&raw const (unsafe *__local_node).next[(unsafe *__local_p)] as *const *mut _TrieNode) as *mut *mut _TrieNode)))

        (__local_next_node = (unsafe *__local_next_prev_ptr))
