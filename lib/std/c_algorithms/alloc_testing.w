...
pub unsafe fn alloc_test_strdup(__param_string: *const i8) -> *mut i8 {
    ...
    (__local_result = ((alloc_test_malloc((((strlen((__param_string as *const c_char)) as c_ulong) +% (1 as c_ulong)) as c_ulong)) as *mut c_char)))
    ...
    strcpy((__local_result as *mut c_char), (__param_string as *const c_char))
