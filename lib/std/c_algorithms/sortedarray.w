...
pub unsafe fn sortedarray_free(__param_sortedarray: *mut _SortedArray) -> Unit {
    if ((if __param_sortedarray != null: 1 else: 0) != 0) {
        with_free((((unsafe *__param_sortedarray).data as *mut c_void) as *mut u8))
...
pub unsafe fn sortedarray_insert(__param_sortedarray: *mut _SortedArray, __param_data: *mut c_void) -> c_int {
    ...
    if ((if (((unsafe *__param_sortedarray).length as c_uint) +% (1 as c_uint)) > (unsafe *__param_sortedarray)._alloced: 1 else: 0) != 0) {
        ...
        (__local_data_1 = (((with_realloc((((unsafe *__param_sortedarray).data as *mut c_void) as *mut u8), (0 as i64), ((((sizeof[usize]() as c_ulong) *% (__local_newsize as c_ulong)) as c_ulong) as i64)) as *mut c_void) as *mut *mut c_void)))
