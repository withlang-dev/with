...
pub unsafe fn adler32_z(__param_adler: c_ulong, __param_buf: *const u8, __param_len: c_ulong) -> c_ulong {
    ...
    if ((if __local_len == 1: 1 else: 0) != 0) {
        (__local_adler = (__local_adler +% ((__local_buf[0]) as c_int)))
    ...
    if ((if __local_len < 16: 1 else: 0) != 0) {
        while true {
            ...
            (__local_adler = (__local_adler +% ((*__ci_expr_old_1) as c_int)))
    ...
    while ((if __local_len >= 5552: 1 else: 0) != 0) {
        ...
        loop {
            ...
            (__local_adler = (__local_adler +% ((__local_buf[(0 + 1)]) as c_int)))
            ...
            (__local_adler = (__local_adler +% ((__local_buf[(0 + 2)]) as c_int)))

            (__local_sum2 = (__local_sum2 +% __local_adler))



            (__local_adler = (__local_adler +% ((__local_buf[((0 + 2) + 1)]) as c_int)))
            ...
            (__local_adler = (__local_adler +% ((__local_buf[(0 + 4)]) as c_int)))

            (__local_sum2 = (__local_sum2 +% __local_adler))



            (__local_adler = (__local_adler +% ((__local_buf[((0 + 4) + 1)]) as c_int)))
            ...
            (__local_adler = (__local_adler +% ((__local_buf[((0 + 4) + 2)]) as c_int)))

            (__local_sum2 = (__local_sum2 +% __local_adler))



            (__local_adler = (__local_adler +% ((__local_buf[(((0 + 4) + 2) + 1)]) as c_int)))
            ...
            (__local_adler = (__local_adler +% ((__local_buf[8]) as c_int)))

            (__local_sum2 = (__local_sum2 +% __local_adler))



            (__local_adler = (__local_adler +% ((__local_buf[(8 + 1)]) as c_int)))
            ...
            (__local_adler = (__local_adler +% ((__local_buf[(8 + 2)]) as c_int)))

            (__local_sum2 = (__local_sum2 +% __local_adler))



            (__local_adler = (__local_adler +% ((__local_buf[((8 + 2) + 1)]) as c_int)))
            ...
            (__local_adler = (__local_adler +% ((__local_buf[(8 + 4)]) as c_int)))

            (__local_sum2 = (__local_sum2 +% __local_adler))



            (__local_adler = (__local_adler +% ((__local_buf[((8 + 4) + 1)]) as c_int)))
            ...
            (__local_adler = (__local_adler +% ((__local_buf[((8 + 4) + 2)]) as c_int)))

            (__local_sum2 = (__local_sum2 +% __local_adler))



            (__local_adler = (__local_adler +% ((__local_buf[(((8 + 4) + 2) + 1)]) as c_int)))
    ...
    if (__local_len != 0) {
        ...
        while true {
            ...
            (__local_adler = (__local_adler +% ((*__ci_expr_old_3) as c_int)))
