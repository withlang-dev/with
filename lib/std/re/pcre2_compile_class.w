...
fn _pcre2_update_classbits_8(ptype: c_uint, pdata: c_uint, negated: c_int, __param_classbits: *mut u8) {
    ...
    while ((if c < 256: 1 else: 0) != 0) {
        ...
        match ptype:
            ...
            12 =>
                (set_bit = (if (((&_pcre2_ucd_boolprop_sets_8[0] as *const c_uint) + (((prop.bprops & 4095) as isize) as usize))[(pdata / 32)] & (1 << (pdata % 32))) != 0: 1 else: 0))
            14 =>
                (chartype = prop.chartype)
        ...
        match __pc:
            0 =>
                ...
                if (utf__goto_1085_6 != 0) {
                    ...
                    if ((if cranges__goto_1095_15.range_list_size > 0: 1 else: 0) != 0) {
                        ...
                        if ((if ranges__goto_1149_21[0] <= 255: 1 else: 0) != 0) {
                        ...
                        if ((if ranges__goto_1149_21[(cranges__goto_1095_15.range_list_size - 1)] == __ci_expr_ternary_0: 1 else: 0) != 0) {
                            (__ci_expr_logic_1 = (if (if ranges__goto_1149_21[(cranges__goto_1095_15.range_list_size - 2)] <= 256: 1 else: 0) != 0: 1 else: 0))
                        }
            ...
            1 =>  // END_PROCESSING
                ...
                if ((if (xclass_props__goto_1093_10 & 1) != 0: 1 else: 0) != 0) {
                    ...
                    var __ci_expr_old_5: *mut u8 = code__goto_1077_14
                    ...
                    ((unsafe: *code__goto_1077_14) = __ci_expr_ternary_6)
                    if (__goto_pending != 0) {
                        continue
                    }
                    ...
                    if ((if (xclass_props__goto_1093_10 & 2) != 0: 1 else: 0) != 0) {
                        ...
                        (__ci_expr_logic_7 = (if (if has_bitmap != null: 1 else: 0) != 0: 1 else: 0))
                    }
                    if (__ci_expr_logic_7 != 0) {
                        if (negate_class != 0) {
                            ...
                            while ((if i__goto_1724_16 < 8: 1 else: 0) != 0) {
                                (classwords__goto_1723_17[i__goto_1724_16] = (~classwords__goto_1723_17[i__goto_1724_16]))
                                if (__goto_pending != 0) {
                                    break
                                }
                        ...
                        if ((if has_bitmap == null: 1 else: 0) != 0) {
                            var __ci_expr_old_8: *mut u8 = code__goto_1077_14
                            (code__goto_1077_14 = code__goto_1077_14 + 1)
                            ((unsafe: *__ci_expr_old_8) = (unsafe: *__ci_expr_old_8) | 2)
                            if (__goto_pending != 0) {
                                continue
                            }
                ...
                if (negate_class != 0) {
                    ...
                    while ((if i__goto_1842_12 < 8: 1 else: 0) != 0) {
                        (classwords__goto_1840_13[i__goto_1842_12] = (~classwords__goto_1840_13[i__goto_1842_12]))
                        if (__goto_pending != 0) {
                            break
                        }
                ...
                if ((if not (utf__goto_1085_6 != 0): 1 else: 0) != 0) {
                    ...
                    (__ci_expr_logic_9 = (if (if negate_class != should_flip_negation__goto_1078_6: 1 else: 0) != 0: 1 else: 0))
                }
                if (__ci_expr_logic_9 != 0) {
                    (__ci_expr_logic_10 = (if (if cb.classbits.classwords[0] == (~(0 as c_uint)): 1 else: 0) != 0: 1 else: 0))
                }
                if (__ci_expr_logic_10 != 0) {
                    ...
                    while ((if i__goto_1849_7 < 8: 1 else: 0) != 0) {
                        if ((if classwords__goto_1848_19[i__goto_1849_7] != (~(0 as c_uint)): 1 else: 0) != 0) {
                            break
                        }
                        if (__goto_pending != 0) {
                            break
                    ...
                    if ((if i__goto_1849_7 == 8: 1 else: 0) != 0) {
                        var __ci_expr_old_11: *mut u8 = code__goto_1077_14
                        (code__goto_1077_14 = code__goto_1077_14 + 1)
                        ((unsafe: *__ci_expr_old_11) = 13)
                        if (__goto_pending != 0) {
                            continue
                        }
                        __pc = 2
                ...
                var __ci_expr_old_12: *mut u8 = code__goto_1077_14
                (code__goto_1077_14 = code__goto_1077_14 + 1)
                var __ci_expr_ternary_13: c_int = 0
                if ((if negate_class == should_flip_negation__goto_1078_6: 1 else: 0) != 0) {
                    (__ci_expr_ternary_13 = OP_CLASS)
                } else {
                    (__ci_expr_ternary_13 = OP_NCLASS)
                }
                ((unsafe: *__ci_expr_old_12) = __ci_expr_ternary_13)
                if (__goto_pending != 0) {
                    continue
                }
                with_memcpy((code__goto_1077_14 as *i8), (classbits__goto_1082_16 as *i8), (32 as i64))
...
fn _pcre2_compile_class_nested_8(options: c_uint, xoptions: c_uint, pptr: *mut *mut c_uint, pcode: *mut *mut u8, errorcodeptr: *mut c_int, cb: *mut compile_block_8, lengthptr: *mut c_ulong) -> c_int {
    ...
    if ((if op_info.op_single_type != 0: 1 else: 0) != 0) {
        ...
        var required_len_2: c_ulong = with 0 as __ci_expr_seq_180 {
...
fn do_heapify(buffer: *mut c_uint, size: c_ulong, __param_i: c_ulong) {
    ...
    while (1 != 0) {
        ...
        if ((if left < size: 1 else: 0) != 0) {
            (__ci_expr_logic_0 = (if (if buffer[left] > buffer[max]: 1 else: 0) != 0: 1 else: 0))
        }
        ...
        if ((if right < size: 1 else: 0) != 0) {
            (__ci_expr_logic_1 = (if (if buffer[right] > buffer[max]: 1 else: 0) != 0: 1 else: 0))
        }
...
fn parse_class(__param_ptr: *mut c_uint, options: c_uint, __param_buffer: *mut c_uint) -> c_ulong {
    ...
    while (1 != 0) {
                ...
                match meta_arg:
                    ...
                    16 | 15 =>
                        ...
                        if ((if meta_arg == 16: 1 else: 0) != 0) {
                            (__ci_expr_logic_0 = (if (if ((unsafe: *ptr) >> 16) == 13: 1 else: 0) != 0: 1 else: 0))
                        }
        ...
        if ((if ptr[1] == 2149777408: 1 else: 0) != 0) {
            (__ci_expr_logic_1 = (if true: 1 else: 0))
        } else {
            (__ci_expr_logic_1 = (if (if ptr[1] == 2149711872: 1 else: 0) != 0: 1 else: 0))
        }
...
fn compile_optimize_class(start_ptr: *mut c_uint, options: c_uint, xoptions: c_uint, cb: *mut compile_block_8) -> *mut class_ranges {
    ...
    while true {
        ...
        if ((if range_list_size > 0: 1 else: 0) != 0) {
            (__ci_expr_logic_2 = (if (if dst[1] != (~(0 as c_uint)): 1 else: 0) != 0: 1 else: 0))
        }
        ...
        if ((if (dst[1] +% 1) < ptr[0]: 1 else: 0) != 0) {
            (dst = dst + 2)
    ...
    while true {
        ...
        if ((if ptr < dst: 1 else: 0) != 0) {
            (__ci_expr_logic_3 = (if (if ptr[1] < 256: 1 else: 0) != 0: 1 else: 0))
        }
    ...
    if ((if (options & 8) != 0: 1 else: 0) != 0) {
        if ((if (options & (524288 | 131072)) != 0: 1 else: 0) != 0) {
            ...
            if ((if classbits_end >= 128: 1 else: 0) != 0) {
                var hi_start: c_uint = with 0 as __ci_expr_seq_55 {
...
fn add_not_list_to_class(options: c_uint, xoptions: c_uint, cb: *mut compile_block_8, __param_p: *const c_uint) {
    ...
    while ((if p[0] < 256: 1 else: 0) != 0) {
        ...
        if ((if p[1] > 255: 1 else: 0) != 0) {
            (__ci_expr_ternary_0 = 255)
        } else {
            (__ci_expr_ternary_0 = (p[1] -% 1))
        }
        
        add_to_class(options, xoptions, cb, (p[0] +% 1), __ci_expr_ternary_0)
                    ...
                    if ((if rhs_op_info.op_single_type == 7: 1 else: 0) != 0) {
                        ...
                        if (not ((if lhs_op_info.op_single_type == 7: 1 else: 0) != 0)) {
                            if ((if lengthptr != null: 1 else: 0) != 0) {
                                ...
                                (rhs_op_info.code_start[rhs_op_info.length] = 1)
                    ...
                    if ((if rhs_op_info.op_single_type == 6: 1 else: 0) != 0) {
                        ...
                        if (not ((if lhs_op_info.op_single_type == 6: 1 else: 0) != 0)) {
                            if ((if lengthptr != null: 1 else: 0) != 0) {
                                ...
                                (rhs_op_info.code_start[rhs_op_info.length] = 2)
                    ...
                    if ((if rhs_op_info.op_single_type == 6: 1 else: 0) != 0) {
                        ...
                        if ((if lhs_op_info.op_single_type == 6: 1 else: 0) != 0) {
                            ...
                            if ((if lengthptr != null: 1 else: 0) != 0) {
                                ...
                                (rhs_op_info.code_start[rhs_op_info.length] = 3)
    ...
    while true {
        match __pc:
            0 =>
                ...
                var __ci_expr_ternary_6: *mut u8 = null
                if ((if lengthptr == null: 1 else: 0) != 0) {
                    (__ci_expr_ternary_6 = code_start__goto_2138_14)
                } else {
                    (__ci_expr_ternary_6 = ((null as *mut u8)))
                }
                (pop_info.code_start = __ci_expr_ternary_6)
                if (__goto_pending != 0) {
                    continue
                }
                if ((if lengthptr != null: 1 else: 0) != 0) {
