...
fn pcre2_get_mark_8(__p0: *mut pcre2_real_match_data_8) -> *const u8:
    var match_data = __p0
    return match_data.mark

@[c_export("pcre2_get_match_data_size_8")]
fn pcre2_get_match_data_size_8(__p0: *mut pcre2_real_match_data_8) -> c_ulong:
    var match_data = __p0
    return (120 +% ((2 * (match_data.oveccount)) *% sizeof[c_ulong]()))

@[c_export("pcre2_get_match_data_heapframes_size_8")]
fn pcre2_get_match_data_heapframes_size_8(__p0: *mut pcre2_real_match_data_8) -> c_ulong:
    var match_data = __p0
    return match_data.heapframes_size

@[c_export("pcre2_get_ovector_count_8")]
fn pcre2_get_ovector_count_8(__p0: *mut pcre2_real_match_data_8) -> c_uint:
    var match_data = __p0
    return match_data.oveccount

@[c_export("pcre2_get_ovector_pointer_8")]
fn pcre2_get_ovector_pointer_8(__p0: *mut pcre2_real_match_data_8) -> *mut c_ulong:
    var match_data = __p0
    return match_data.ovector

@[c_export("pcre2_get_startchar_8")]
fn pcre2_get_startchar_8(__p0: *mut pcre2_real_match_data_8) -> c_ulong:
    var match_data = __p0
