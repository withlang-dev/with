...
fn pcre2_general_context_copy_8(__p0: *mut pcre2_real_general_context_8) -> *mut pcre2_real_general_context_8:
    ...
    mem_copy(newcontext, gcontext, sizeof[pcre2_real_general_context_8]())
    return newcontext

@[c_export("pcre2_general_context_create_8")]
fn pcre2_general_context_create_8(__p0: *const fn(c_ulong, *mut c_void) -> *mut c_void, __p1: *const fn(*mut c_void, *mut c_void) -> void, __p2: *mut c_void) -> *mut pcre2_real_general_context_8:
...
fn pcre2_general_context_free_8(__p0: *mut pcre2_real_general_context_8):
    var gcontext = __p0
    if (if gcontext != ((0 as *mut c_void)): 1 else: 0) != 0:
...
fn pcre2_compile_context_copy_8(__p0: *mut pcre2_real_compile_context_8) -> *mut pcre2_real_compile_context_8:
    ...
    mem_copy(newcontext, ccontext, sizeof[pcre2_real_compile_context_8]())
    return newcontext
...
fn pcre2_compile_context_free_8(__p0: *mut pcre2_real_compile_context_8):
    var ccontext = __p0
    if (if ccontext != ((0 as *mut c_void)): 1 else: 0) != 0:
...
fn pcre2_set_bsr_8(__p0: *mut pcre2_real_compile_context_8, __p1: c_uint) -> c_int:
    var ccontext = __p0
    var value = __p1
    match value
        2 =>
...
fn pcre2_set_character_tables_8(__p0: *mut pcre2_real_compile_context_8, __p1: *const u8) -> c_int:
    var ccontext = __p0
    var tables = __p1
    (ccontext.tables = tables)
    return 0

@[c_export("pcre2_set_compile_extra_options_8")]
fn pcre2_set_compile_extra_options_8(__p0: *mut pcre2_real_compile_context_8, __p1: c_uint) -> c_int:
    var ccontext = __p0
    var options = __p1
    (ccontext.extra_options = options)
    return 0

@[c_export("pcre2_set_max_pattern_length_8")]
fn pcre2_set_max_pattern_length_8(__p0: *mut pcre2_real_compile_context_8, __p1: c_ulong) -> c_int:
    var ccontext = __p0
    var length = __p1
    (ccontext.max_pattern_length = length)
    return 0

@[c_export("pcre2_set_max_pattern_compiled_length_8")]
fn pcre2_set_max_pattern_compiled_length_8(__p0: *mut pcre2_real_compile_context_8, __p1: c_ulong) -> c_int:
    var ccontext = __p0
    var length = __p1
    (ccontext.max_pattern_compiled_length = length)
    return 0

@[c_export("pcre2_set_max_varlookbehind_8")]
fn pcre2_set_max_varlookbehind_8(__p0: *mut pcre2_real_compile_context_8, __p1: c_uint) -> c_int:
    var ccontext = __p0
    var limit = __p1
...
fn pcre2_set_newline_8(__p0: *mut pcre2_real_compile_context_8, __p1: c_uint) -> c_int:
    var ccontext = __p0
    var newline = __p1
    match newline
        1 =>
...
fn pcre2_set_parens_nest_limit_8(__p0: *mut pcre2_real_compile_context_8, __p1: c_uint) -> c_int:
    var ccontext = __p0
    var limit = __p1
    (ccontext.parens_nest_limit = limit)
    return 0

@[c_export("pcre2_set_compile_recursion_guard_8")]
fn pcre2_set_compile_recursion_guard_8(__p0: *mut pcre2_real_compile_context_8, __p1: *const fn(c_uint, *mut c_void) -> c_int, __p2: *mut c_void) -> c_int:
    var ccontext = __p0
    var guard = __p1
    var user_data = __p2
...
fn pcre2_set_optimize_8(__p0: *mut pcre2_real_compile_context_8, __p1: c_uint) -> c_int:
    var ccontext = __p0
    var directive = __p1
    match directive
        0 =>
...
fn pcre2_convert_context_copy_8(__p0: *mut pcre2_real_convert_context_8) -> *mut pcre2_real_convert_context_8:
    ...
    mem_copy(newcontext, ccontext, sizeof[pcre2_real_convert_context_8]())
    return newcontext
...
fn pcre2_convert_context_free_8(__p0: *mut pcre2_real_convert_context_8):
    var ccontext = __p0
    if (if ccontext != ((0 as *mut c_void)): 1 else: 0) != 0:
        ccontext.memctl.free(ccontext, ccontext.memctl.memory_data)
...
fn pcre2_set_glob_escape_8(__p0: *mut pcre2_real_convert_context_8, __p1: c_uint) -> c_int:
    var ccontext = __p0
    var escape = __p1
    (ccontext.glob_escape = escape)
    return 0

@[c_export("pcre2_set_glob_separator_8")]
fn pcre2_set_glob_separator_8(__p0: *mut pcre2_real_convert_context_8, __p1: c_uint) -> c_int:
    var ccontext = __p0
    var separator = __p1
...
fn pcre2_match_context_copy_8(__p0: *mut pcre2_real_match_context_8) -> *mut pcre2_real_match_context_8:
    ...
    mem_copy(newcontext, mcontext, sizeof[pcre2_real_match_context_8]())
    return newcontext
...
fn pcre2_match_context_free_8(__p0: *mut pcre2_real_match_context_8):
    var mcontext = __p0
    if (if mcontext != ((0 as *mut c_void)): 1 else: 0) != 0:
...
fn pcre2_set_callout_8(__p0: *mut pcre2_real_match_context_8, __p1: *const fn(*mut pcre2_callout_block_8, *mut c_void) -> c_int, __p2: *mut c_void) -> c_int:
    var mcontext = __p0
    var callout = __p1
...
@[c_export("pcre2_set_substitute_callout_8")]
fn pcre2_set_substitute_callout_8(__p0: *mut pcre2_real_match_context_8, __p1: *const fn(*mut pcre2_substitute_callout_block_8, *mut c_void) -> c_int, __p2: *mut c_void) -> c_int:
    var mcontext = __p0
    var substitute_callout = __p1
    var substitute_callout_data = __p2
    (mcontext.substitute_callout = substitute_callout)
    (mcontext.substitute_callout_data = substitute_callout_data)
    return 0

@[c_export("pcre2_set_substitute_case_callout_8")]
fn pcre2_set_substitute_case_callout_8(__p0: *mut pcre2_real_match_context_8, __p1: *const fn(*const u8, c_ulong, *mut u8, c_ulong, c_int, *mut c_void) -> c_ulong, __p2: *mut c_void) -> c_int:
    var mcontext = __p0
    var substitute_case_callout = __p1
    var substitute_case_callout_data = __p2
...
@[c_export("pcre2_set_depth_limit_8")]
fn pcre2_set_depth_limit_8(__p0: *mut pcre2_real_match_context_8, __p1: c_uint) -> c_int:
    var mcontext = __p0
    var limit = __p1
    (mcontext.depth_limit = limit)
    return 0

@[c_export("pcre2_set_heap_limit_8")]
fn pcre2_set_heap_limit_8(__p0: *mut pcre2_real_match_context_8, __p1: c_uint) -> c_int:
    var mcontext = __p0
    var limit = __p1
    (mcontext.heap_limit = limit)
    return 0

@[c_export("pcre2_set_match_limit_8")]
fn pcre2_set_match_limit_8(__p0: *mut pcre2_real_match_context_8, __p1: c_uint) -> c_int:
    var mcontext = __p0
    var limit = __p1
    (mcontext.match_limit = limit)
    return 0

@[c_export("pcre2_set_offset_limit_8")]
fn pcre2_set_offset_limit_8(__p0: *mut pcre2_real_match_context_8, __p1: c_ulong) -> c_int:
    var mcontext = __p0
    var limit = __p1
    (mcontext.offset_limit = limit)
    return 0

@[c_export("pcre2_set_recursion_limit_8")]
fn pcre2_set_recursion_limit_8(__p0: *mut pcre2_real_match_context_8, __p1: c_uint) -> c_int:
    var mcontext = __p0
    var limit = __p1
    return pcre2_set_depth_limit_8(mcontext, limit)

@[c_export("pcre2_set_recursion_memory_management_8")]
fn pcre2_set_recursion_memory_management_8(__p0: *mut pcre2_real_match_context_8, __p1: *const fn(c_ulong, *mut c_void) -> *mut c_void, __p2: *const fn(*mut c_void, *mut c_void) -> void, __p3: *mut c_void) -> c_int:
    var mcontext = __p0
    var mymalloc = __p1
    var myfree = __p2
    var mydata = __p3
