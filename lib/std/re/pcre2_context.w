...
fn pcre2_set_glob_escape_8(ccontext: *mut pcre2_real_convert_context_8, escape: c_uint) -> c_int:
    if ((escape > 255) or ((escape != 0) and (string_find_char(globpunct, escape) == null))):
        return (-29)
...
fn _pcre2_memctl_malloc_8(size: c_ulong, memctl: *mut pcre2_memctl) -> *mut c_void:
    ...
    var yield_: *mut c_void = (if (memctl == null): (with_alloc(size as i64) as *mut c_void) else: memctl.malloc(size, memctl.memory_data))
...
var globpunct: *const i8 = "\041\042\043\044\045\046\047\050\051\052\053\054\055\056\057\072\073\074\075\076\077\100\133\134\135\136\137\140\173\174\175\176"
