...
fn pcre2_match_8(__p0: *const pcre2_real_code_8, __p1: *const u8, __p2: c_ulong, __p3: c_ulong, __p4: c_uint, __p5: *mut pcre2_real_match_data_8, __p6: *mut pcre2_real_match_context_8) -> c_int:
    var code = __p0
    var subject = __p1
    var length = __p2
...
(mb.memctl = mcontext.memctl)
                ...
                (mb.mark = (mb.nomatch_mark = ((0 as *mut c_void))))
...
(heapframes_size = 20480)
                ...
                mem_set((((match_data.heapframes) as *mut i8) + 120), 255, (frame_size -% 120))
...
(start_bits = re.start_bitmap)
                ...
                (start_partial = (match_partial = ((0 as *mut c_void))))
                (mb.hitend = 0)
                ...
                while true:
                    ...
                    if (if mb.hitend and (if start_partial == ((0 as *mut c_void)): 1 else: 0): 1 else: 0) != 0:
