...
fn pcre2_pattern_info_8(__p0: *const pcre2_real_code_8, __p1: c_uint, __p2: *mut c_void) -> c_int:
    var code = __p0
    var what = __p1
    var where_ = __p2
...
fn pcre2_callout_enumerate_8(__p0: *const pcre2_real_code_8, __p1: *const fn(*mut pcre2_callout_enumerate_block_8, *mut c_void) -> c_int, __p2: *mut c_void) -> c_int:
    var code = __p0
    var callback = __p1
    ...
    while 1 != 0:
        ...
        match unsafe: *cc
            ...
            OP_CALLOUT =>
                ...
                (cb.callout_string = ((0 as *mut c_void)))
