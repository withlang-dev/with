...
fn pcre2_serialize_encode_8(codes: *mut *const pcre2_real_code_8, number_of_codes: c_int, serialized_bytes: *mut *mut u8, serialized_size: *mut c_ulong, gcontext: *mut pcre2_real_general_context_8) -> c_int:
    ...
    var memctl: *const pcre2_memctl = ((if (gcontext != (null as *mut pcre2_real_general_context_8)): ((&gcontext.memctl as *const pcre2_memctl) as *mut pcre2_memctl) else: ((&_pcre2_default_compile_context_8.memctl as *const pcre2_memctl) as *mut pcre2_memctl)) as *const pcre2_memctl)
    if (((codes == (null as *mut *const pcre2_real_code_8)) or (serialized_bytes == (null as *mut *mut u8))) or (serialized_size == (null as *mut c_ulong))):
        return (-51)
    ...
    while true:
        match __pc
            0 =>
                ...
                memctl__goto_181_21 = ((if (gcontext != (null as *mut pcre2_real_general_context_8)): ((&gcontext.memctl as *const pcre2_memctl) as *mut pcre2_memctl) else: ((&_pcre2_default_compile_context_8.memctl as *const pcre2_memctl) as *mut pcre2_memctl)) as *const pcre2_memctl)
                dst_re__goto_185_18 = (null as *mut pcre2_real_code_8)
                if ((data__goto_180_30 == (null as *const pcre2_serialized_data)) or (codes == (null as *mut *mut pcre2_real_code_8))):
                    return (-51)
                if __goto_pending != 0:
                    continue
                if (number_of_codes <= 0):
                ...
                if __goto_pending != 0:
                    continue
                if (data__goto_180_30.number_of_codes <= 0):
                    return (-62)
                if __goto_pending != 0:
                    continue
                if (data__goto_180_30.magic != 1347564115):
                    return (-31)
                if __goto_pending != 0:
                    continue
                if (data__goto_180_30.version != 3145738):
                    return (-32)
                if __goto_pending != 0:
                    continue
                if (number_of_codes > data__goto_180_30.number_of_codes):
                ...
                if __goto_pending != 0:
                    continue
                if (tables__goto_186_10 == (null as *mut u8)):
                    return (-48)
                if __goto_pending != 0:
                    continue
                ...
                if __goto_pending != 0:
                    continue
                ((unsafe: *(((tables__goto_186_10 + (((((512 + 320)) + 256)) as isize as usize))) as *mut c_ulong)) = number_of_codes)
                if __goto_pending != 0:
                    continue
                src_bytes__goto_184_16 = src_bytes__goto_184_16 + ((((512 + 320)) + 256))
                if __goto_pending != 0:
                    continue
                (i__goto_187_9 = 0)
                while (i__goto_187_9 < number_of_codes):
                    with_memcpy((((&blocksize__goto_222_23 as *const c_ulong) as *mut c_ulong) as *mut c_void) as *i8, ((src_bytes__goto_184_16 + 72) as *const c_void) as *i8, sizeof[c_ulong]() as i64)
                    if __goto_pending != 0:
                        break
                    if (blocksize__goto_222_23 <= sizeof[pcre2_real_code_8]()):
                    ...
                    if __goto_pending != 0:
                        break
                    if (dst_re__goto_185_18 == (null as *mut pcre2_real_code_8)):
                    ...
                    if __goto_pending != 0:
                        break
                    if (((dst_re__goto_185_18.magic_number != 1346589253) or (dst_re__goto_185_18.name_entry_size > ((128 + 2) + 1))) or (dst_re__goto_185_18.name_count > 10000)):
                        (error___goto_188_9 = (-62))
                        if __goto_pending != 0:
                            break
                        __pc = 1
            ...
            1 =>  // cleanup
                ...
                if __goto_pending != 0:
                    continue
                (j__goto_187_12 = 0)
                while (j__goto_187_12 < i__goto_187_9):
...
fn pcre2_serialize_get_number_of_codes_8(bytes: *const u8) -> c_int:
    ...
    if (data == (null as *const pcre2_serialized_data)):
        return (-51)

    if (data.magic != 1347564115):
        return (-31)

    if (data.version != 3145738):
        return (-32)
