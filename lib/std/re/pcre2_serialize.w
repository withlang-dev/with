...
fn pcre2_serialize_encode_8(__p0: *mut *const pcre2_real_code_8, __p1: c_int, __p2: *mut *mut u8, __p3: *mut c_ulong, __p4: *mut pcre2_real_general_context_8) -> c_int:
    var codes = __p0
    var number_of_codes = __p1
    ...
    mem_copy(bytes, memctl, sizeof[pcre2_memctl]())
    ...
    mem_copy(dst_bytes, tables, 1088)
    (i = 0)
    while (if i < number_of_codes: 1 else: 0) != 0:
        mem_copy(dst_bytes, (re as *const i8), re.blocksize)
        mem_set((dst_bytes + 0), 0, sizeof[pcre2_memctl]())
...
fn pcre2_serialize_decode_8(__p0: *mut *mut pcre2_real_code_8, __p1: c_int, __p2: *const u8, __p3: *mut pcre2_real_general_context_8) -> c_int:
    var codes = __p0
    var number_of_codes = __p1
    var bytes = __p2
    var gcontext = __p3
