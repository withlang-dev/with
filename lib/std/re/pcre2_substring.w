...
pub unsafe fn pcre2_substring_copy_byname_8(__param_match_data: *mut pcre2_real_match_data_8, __param_stringname: *const u8, __param_buffer: *mut u8, __param_sizeptr: *mut c_ulong) -> c_int {
    ...
    (__local_entrysize = ((pcre2_substring_nametable_scan_8((*__param_match_data).code, __param_stringname, (&raw mut __local_first as *mut *const u8), (&raw mut __local_last as *mut *const u8)) as c_int)))
...
pub unsafe fn pcre2_substring_copy_bynumber_8(__param_match_data: *mut pcre2_real_match_data_8, __param_stringnumber: c_uint, __param_buffer: *mut u8, __param_sizeptr: *mut c_ulong) -> c_int {
    ...
    if ((if ((__local_size as c_ulong) +% (1 as c_ulong)) > (*__param_sizeptr): 1 else: 0) != 0) {
        return -48
    }

    if ((if __local_size != 0: 1 else: 0) != 0) {
        with_memcpy(((__param_buffer as *mut c_void) as *mut u8), ((((*__param_match_data).subject + ((*__param_match_data).ovector[((__param_stringnumber as c_uint) *% (2 as c_uint))] as usize)) as *const c_void) as *const u8), ((((__local_size as c_ulong) *% (1 as c_ulong)) as c_ulong) as i64))
    }

    ((__param_buffer[__local_size]) = ((0 as u8)))

    ((*__param_sizeptr) = __local_size)
...
pub unsafe fn pcre2_substring_get_bynumber_8(__param_match_data: *mut pcre2_real_match_data_8, __param_stringnumber: c_uint, __param_stringptr: *mut *mut u8, __param_sizeptr: *mut c_ulong) -> c_int {
    ...
    if ((if __local_size != 0: 1 else: 0) != 0) {
        with_memcpy(((__local_yield_ as *mut c_void) as *mut u8), ((((*__param_match_data).subject + ((*__param_match_data).ovector[((__param_stringnumber as c_uint) *% (2 as c_uint))] as usize)) as *const c_void) as *const u8), ((((__local_size as c_ulong) *% (1 as c_ulong)) as c_ulong) as i64))
    }

    ((__local_yield_[__local_size]) = ((0 as u8)))

    ((*__param_stringptr) = __local_yield_)
...
pub unsafe fn pcre2_substring_length_bynumber_8(__param_match_data: *mut pcre2_real_match_data_8, __param_stringnumber: c_uint, __param_sizeptr: *mut c_ulong) -> c_int {
    ...
    (__local_left = (((*__param_match_data).ovector[((__param_stringnumber as c_uint) *% (2 as c_uint))] as c_ulong)))

    (__local_right = (((*__param_match_data).ovector[((((__param_stringnumber as c_uint) *% (2 as c_uint)) as c_uint) +% (1 as c_uint))] as c_ulong)))
...
pub unsafe fn pcre2_substring_list_get_8(__param_match_data: *mut pcre2_real_match_data_8, __param_listptr: *mut *mut *mut u8, __param_lengthsptr: *mut *mut c_ulong) -> c_int {
    ...
    if ((if __local_count == 0: 1 else: 0) != 0) {
        (__local_count = (((*__param_match_data).oveccount as c_int)))
    }

    (__local_count2 = (((2 * __local_count) as c_int)))

    (__local_ovector = (&(*__param_match_data).ovector[0] as *mut c_ulong))
    ...
    while ((if __local_i < __local_count2: 1 else: 0) != 0) {
        ...
        if ((if (__local_ovector[(__local_i + 1)]) > (__local_ovector[__local_i]): 1 else: 0) != 0) {
            (__local_size = (__local_size +% (((((__local_ovector[(__local_i + 1)]) as c_ulong) -% ((__local_ovector[__local_i]) as c_ulong)) as c_ulong) *% (1 as c_ulong))))
        }
    ...
    if ((if __param_lengthsptr == null: 1 else: 0) != 0) {
        ...
        ((*__param_lengthsptr) = __local_lensp)
