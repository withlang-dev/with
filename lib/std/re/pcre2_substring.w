...
pub unsafe fn pcre2_substring_copy_byname_8(__param_match_data: *mut pcre2_real_match_data_8, __param_stringname: *const u8, __param_buffer: *mut u8, __param_sizeptr: *mut c_ulong) -> c_int {
    ...
    if ((if (unsafe *__param_match_data).matchedby == PCRE2_MATCHEDBY_DFA_INTERPRETER: 1 else: 0) != 0) {
        return -41
    }

    (__local_entrysize = ((pcre2_substring_nametable_scan_8((unsafe *__param_match_data).code, __param_stringname, (&raw mut __local_first as *mut *const u8), (&raw mut __local_last as *mut *const u8)) as c_int)))

    if ((if __local_entrysize < 0: 1 else: 0) != 0) {
        return __local_entrysize
    }

    (__local_failrc = ((-54 as c_int)))

    (__local_entry = __local_first)

    while ((if __local_entry <= __local_last: 1 else: 0) != 0) {
        var __local_n: c_uint = (((((((unsafe __local_entry[0]) as c_int) << (8 as c_uint)) as c_int) | (((unsafe __local_entry[(0 + 1)]) as c_int) as c_int)) as c_uint))

        if ((if __local_n < (unsafe *__param_match_data).oveccount: 1 else: 0) != 0) {
            if ((if (unsafe *__param_match_data).ovector[((__local_n as c_uint) *% (2 as c_uint))] != (~(0 as c_ulong)): 1 else: 0) != 0) {
                return pcre2_substring_copy_bynumber_8(__param_match_data, __local_n, __param_buffer, __param_sizeptr)
            }

            (__local_failrc = ((-55 as c_int)))
...
pub unsafe fn pcre2_substring_copy_bynumber_8(__param_match_data: *mut pcre2_real_match_data_8, __param_stringnumber: c_uint, __param_buffer: *mut u8, __param_sizeptr: *mut c_ulong) -> c_int {
    var __local_rc: c_int

    var __local_size: c_ulong

    (__local_rc = ((pcre2_substring_length_bynumber_8(__param_match_data, __param_stringnumber, (&raw mut __local_size as *mut c_ulong)) as c_int)))
    ...
    if ((if __local_size != 0: 1 else: 0) != 0) {
        with_memcpy(((__param_buffer as *mut c_void) as *mut u8), ((((unsafe *__param_match_data).subject + ((unsafe *__param_match_data).ovector[((__param_stringnumber as c_uint) *% (2 as c_uint))] as usize)) as *const c_void) as *const u8), ((((__local_size as c_ulong) *% (1 as c_ulong)) as c_ulong) as i64))
    }

    ((unsafe __param_buffer[__local_size]) = ((0 as u8)))
...
pub unsafe fn pcre2_substring_get_byname_8(__param_match_data: *mut pcre2_real_match_data_8, __param_stringname: *const u8, __param_stringptr: *mut *mut u8, __param_sizeptr: *mut c_ulong) -> c_int {
    var __local_first: *const u8
...
pub unsafe fn pcre2_substring_get_bynumber_8(__param_match_data: *mut pcre2_real_match_data_8, __param_stringnumber: c_uint, __param_stringptr: *mut *mut u8, __param_sizeptr: *mut c_ulong) -> c_int {
    var __local_rc: c_int
    ...
    (__local_yield_ = ((_pcre2_memctl_malloc_8((((sizeof[pcre2_memctl]() as c_ulong) +% (((((__local_size as c_ulong) +% (1 as c_ulong)) as c_ulong) *% (8 as c_ulong)) as c_ulong)) as c_ulong), (__param_match_data as *mut pcre2_memctl)) as *mut u8)))
    ...
    if ((if __local_size != 0: 1 else: 0) != 0) {
        with_memcpy(((__local_yield_ as *mut c_void) as *mut u8), ((((unsafe *__param_match_data).subject + ((unsafe *__param_match_data).ovector[((__param_stringnumber as c_uint) *% (2 as c_uint))] as usize)) as *const c_void) as *const u8), ((((__local_size as c_ulong) *% (1 as c_ulong)) as c_ulong) as i64))
    }

    ((unsafe __local_yield_[__local_size]) = ((0 as u8)))
...
pub unsafe fn pcre2_substring_length_byname_8(__param_match_data: *mut pcre2_real_match_data_8, __param_stringname: *const u8, __param_sizeptr: *mut c_ulong) -> c_int {
    var __local_first: *const u8
...
pub unsafe fn pcre2_substring_length_bynumber_8(__param_match_data: *mut pcre2_real_match_data_8, __param_stringnumber: c_uint, __param_sizeptr: *mut c_ulong) -> c_int {
    var __local_left: c_ulong

    var __local_right: c_ulong


    var __local_count: c_int = (unsafe *__param_match_data).rc
    ...
    if ((if (unsafe *__param_match_data).matchedby != PCRE2_MATCHEDBY_DFA_INTERPRETER: 1 else: 0) != 0) {
        if ((if __param_stringnumber > (unsafe *(unsafe *__param_match_data).code).top_bracket: 1 else: 0) != 0) {
            return -49
        }

        if ((if __param_stringnumber >= (unsafe *__param_match_data).oveccount: 1 else: 0) != 0) {
            return -54
        }

        if ((if (unsafe *__param_match_data).ovector[((__param_stringnumber as c_uint) *% (2 as c_uint))] == (~(0 as c_ulong)): 1 else: 0) != 0) {
            return -55
        }
    ...
    (__local_left = (((unsafe *__param_match_data).ovector[((__param_stringnumber as c_uint) *% (2 as c_uint))] as c_ulong)))

    (__local_right = (((unsafe *__param_match_data).ovector[((((__param_stringnumber as c_uint) *% (2 as c_uint)) as c_uint) +% (1 as c_uint))] as c_ulong)))

    var __ci_expr_logic_1: c_int

    if ((if __local_left > (unsafe *__param_match_data).subject_length: 1 else: 0) != 0) {
        (__ci_expr_logic_1 = (if true: 1 else: 0))
    } else {
        (__ci_expr_logic_1 = (if (if __local_right > (unsafe *__param_match_data).subject_length: 1 else: 0) != 0: 1 else: 0))
    }
...
pub unsafe fn pcre2_substring_nametable_scan_8(__param_code: *const pcre2_real_code_8, __param_stringname: *const u8, __param_firstptr: *mut *const u8, __param_lastptr: *mut *const u8) -> c_int {
    var __local_bot: c_ushort = ((0 as c_ushort))

    var __local_top: c_ushort = (unsafe *__param_code).name_count

    var __local_entrysize: c_ushort = (unsafe *__param_code).name_entry_size
    ...
    while ((if __local_top > __local_bot: 1 else: 0) != 0) {
        ...
        var __local_c: c_int = ((_pcre2_strcmp_8(__param_stringname, (__local_entry + ((2 as isize) as usize))) as c_int))
        ...
        if ((if __local_c == 0: 1 else: 0) != 0) {
            ...
            (__local_lastentry = __local_nametable + ((((__local_entrysize as c_int) * (((unsafe *__param_code).name_count as c_int) - 1)) as isize) as usize))
            ...
            while ((if __local_first > __local_nametable: 1 else: 0) != 0) {
                ...
                (__local_first = __local_first - (((__local_entrysize as c_uint) as usize) as c_int))
            ...
            while ((if __local_last < __local_lastentry: 1 else: 0) != 0) {
                ...
                (__local_last = __local_last + (((__local_entrysize as c_uint) as usize) as c_int))
            ...
            if ((if __param_firstptr == null: 1 else: 0) != 0) {
                ...
                if ((if __local_first == __local_last: 1 else: 0) != 0) {
                    (__ci_expr_ternary_0 = ((((((((unsafe __local_entry[0]) as c_int) << (8 as c_uint)) as c_int) | (((unsafe __local_entry[(0 + 1)]) as c_int) as c_int)) as c_uint) as c_int)))
                } else {
            ...
            return ((__local_entrysize as c_int))

        }

        if ((if __local_c > 0: 1 else: 0) != 0) {
            (__local_bot = ((((__local_mid as c_int) + 1) as c_ushort)))
        } else {
...
pub unsafe fn pcre2_substring_number_from_name_8(__param_code: *const pcre2_real_code_8, __param_stringname: *const u8) -> c_int {
    return pcre2_substring_nametable_scan_8(__param_code, __param_stringname, (null as *mut *const u8), (null as *mut *const u8))
...
pub unsafe fn pcre2_substring_list_get_8(__param_match_data: *mut pcre2_real_match_data_8, __param_listptr: *mut *mut *mut u8, __param_lengthsptr: *mut *mut c_ulong) -> c_int {
    var __local_i: c_int
    ...
    (__local_count = (unsafe *__param_match_data).rc)
    ...
    if ((if __local_count == 0: 1 else: 0) != 0) {
        (__local_count = (((unsafe *__param_match_data).oveccount as c_int)))
    }

    (__local_count2 = (((2 * __local_count) as c_int)))

    (__local_ovector = (&(unsafe *__param_match_data).ovector[0] as *mut c_ulong))

    (__local_size = ((((sizeof[pcre2_memctl]() as c_ulong) +% (sizeof[usize]() as c_ulong)) as c_ulong)))
    ...
    while ((if __local_i < __local_count2: 1 else: 0) != 0) {
        ...
        if ((if (unsafe __local_ovector[(__local_i + 1)]) > (unsafe __local_ovector[__local_i]): 1 else: 0) != 0) {
            (__ci_expr_ternary_0 = (((((unsafe __local_ovector[(__local_i + 1)]) as c_ulong) -% ((unsafe __local_ovector[__local_i]) as c_ulong)) as c_ulong)))
        } else {
        ...
        if ((if __local_size != 0: 1 else: 0) != 0) {
            with_memcpy(((__local_sp as *mut c_void) as *mut u8), ((((unsafe *__param_match_data).subject + ((unsafe __local_ovector[__local_i]) as usize)) as *const c_void) as *const u8), ((((__local_size as c_ulong) *% (1 as c_ulong)) as c_ulong) as i64))
        }
        ...
        ((unsafe *__ci_expr_old_3) = ((0 as u8)))
