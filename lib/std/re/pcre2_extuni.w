...
fn _pcre2_extuni_8(__param_c: c_uint, __param_eptr: *const u8, __param_start_subject: *const u8, __param_end_subject: *const u8, __param_utf: c_int, __param_xcount: *mut c_int) -> *const u8 {
    ...
    var __local_lgb: c_int = ((&(unsafe: _pcre2_ucd_records_8[0]) as *const ucd_record) + ((_pcre2_ucd_stage2_8[(((_pcre2_ucd_stage1_8[((__local_c as c_int) / 128)] as c_int) * 128) + ((__local_c as c_int) % 128))] as c_uint) as usize)).gbprop
    ...
    while ((if __local_eptr < __param_end_subject: 1 else: 0) != 0) {
        ...
        (__local_rgb = ((&(unsafe: _pcre2_ucd_records_8[0]) as *const ucd_record) + ((_pcre2_ucd_stage2_8[(((_pcre2_ucd_stage1_8[((__local_c as c_int) / 128)] as c_int) * 128) + ((__local_c as c_int) % 128))] as c_uint) as usize)).gbprop)
        ...
        if (__ci_expr_logic_2 != 0) {
            ...
            while ((if __local_bptr > __param_start_subject: 1 else: 0) != 0) {
                ...
                if ((if ((&(unsafe: _pcre2_ucd_records_8[0]) as *const ucd_record) + ((_pcre2_ucd_stage2_8[(((_pcre2_ucd_stage1_8[((__local_c as c_int) / 128)] as c_int) * 128) + ((__local_c as c_int) % 128))] as c_uint) as usize)).gbprop != ucp_gbRegional_Indicator: 1 else: 0) != 0) {
                    break
                }
