...
fn _pcre2_extuni_8(__param_c: c_uint, __param_eptr: *const u8, start_subject: *const u8, end_subject: *const u8, utf: c_int, xcount: *mut c_int) -> *const u8 {
    ...
    while ((if eptr < end_subject: 1 else: 0) != 0) {
        ...
        if ((if not (utf != 0): 1 else: 0) != 0) {
            ...
            if ((if c >= 192: 1 else: 0) != 0) {
                if ((if (c & 32) == 0: 1 else: 0) != 0) {
                    (c = ((c & 31) << 6) | ((unsafe: eptr[1]) & 63))

                    (len = len + 1)

                } else {
                    if ((if (c & 16) == 0: 1 else: 0) != 0) {
                        (c = (((c & 15) << 12) | (((unsafe: eptr[1]) & 63) << 6)) | ((unsafe: eptr[2]) & 63))

                        (len = len + 2)

                    } else {
                        if ((if (c & 8) == 0: 1 else: 0) != 0) {
                            (c = ((((c & 7) << 18) | (((unsafe: eptr[1]) & 63) << 12)) | (((unsafe: eptr[2]) & 63) << 6)) | ((unsafe: eptr[3]) & 63))

                            (len = len + 3)

                        } else {
                            if ((if (c & 4) == 0: 1 else: 0) != 0) {
                                (c = (((((c & 3) << 24) | (((unsafe: eptr[1]) & 63) << 18)) | (((unsafe: eptr[2]) & 63) << 12)) | (((unsafe: eptr[3]) & 63) << 6)) | ((unsafe: eptr[4]) & 63))

                                (len = len + 4)

                            } else {
                                (c = ((((((c & 1) << 30) | (((unsafe: eptr[1]) & 63) << 24)) | (((unsafe: eptr[2]) & 63) << 18)) | (((unsafe: eptr[3]) & 63) << 12)) | (((unsafe: eptr[4]) & 63) << 6)) | ((unsafe: eptr[5]) & 63))
        ...
        if ((if (_pcre2_ucp_gbtable_8[lgb] & (1 << rgb)) == 0: 1 else: 0) != 0) {
            break
        }
        ...
        if (__ci_expr_logic_2 != 0) {
            ...
            while ((if bptr > start_subject: 1 else: 0) != 0) {
                ...
                if (utf != 0) {
                    ...
                    if ((if c >= 192: 1 else: 0) != 0) {
                        if ((if (c & 32) == 0: 1 else: 0) != 0) {
                            (c = ((c & 31) << 6) | ((unsafe: bptr[1]) & 63))
                        } else {
                            if ((if (c & 16) == 0: 1 else: 0) != 0) {
                                (c = (((c & 15) << 12) | (((unsafe: bptr[1]) & 63) << 6)) | ((unsafe: bptr[2]) & 63))
                            } else {
                                if ((if (c & 8) == 0: 1 else: 0) != 0) {
                                    (c = ((((c & 7) << 18) | (((unsafe: bptr[1]) & 63) << 12)) | (((unsafe: bptr[2]) & 63) << 6)) | ((unsafe: bptr[3]) & 63))
                                } else {
                                    if ((if (c & 4) == 0: 1 else: 0) != 0) {
                                        (c = (((((c & 3) << 24) | (((unsafe: bptr[1]) & 63) << 18)) | (((unsafe: bptr[2]) & 63) << 12)) | (((unsafe: bptr[3]) & 63) << 6)) | ((unsafe: bptr[4]) & 63))
                                    } else {
                                        (c = ((((((c & 1) << 30) | (((unsafe: bptr[1]) & 63) << 24)) | (((unsafe: bptr[2]) & 63) << 18)) | (((unsafe: bptr[3]) & 63) << 12)) | (((unsafe: bptr[4]) & 63) << 6)) | ((unsafe: bptr[5]) & 63))
                                    }
                                }
                            }
                        }
