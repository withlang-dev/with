...
fn _pcre2_extuni_8(__param_c: c_uint, __param_eptr: *const u8, start_subject: *const u8, end_subject: *const u8, utf: c_int, xcount: *mut c_int) -> *const u8:
    ...
    var lgb: c_int = (((&_pcre2_ucd_records_8[0] as *mut ucd_record) + (_pcre2_ucd_stage2_8[((_pcre2_ucd_stage1_8[(((c) as c_int) / 128)] * 128) + (((c) as c_int) % 128))] as isize as usize))).gbprop
    ...
    while (eptr < end_subject):
        ...
        (rgb = (((&_pcre2_ucd_records_8[0] as *mut ucd_record) + (_pcre2_ucd_stage2_8[((_pcre2_ucd_stage1_8[(((c) as c_int) / 128)] * 128) + (((c) as c_int) % 128))] as isize as usize))).gbprop)
        
        if (((_pcre2_ucp_gbtable_8[lgb] & ((1 << rgb)))) == 0):
            break
        
        if (((lgb == ucp_gbZWJ) and (rgb == ucp_gbExtended_Pictographic)) and (not ((was_ep_ZWJ != 0)))):
            break
        
        if ((lgb == ucp_gbRegional_Indicator) and (rgb == ucp_gbRegional_Indicator)):
            var ricount: c_int = 0
                ...
                if (utf != 0):
                    ...
                    if (c >= 192):
                        if (((c & 32)) == 0):
                            ...
                            if (((c & 16)) == 0):
                                (c = ((((((c & 15)) << 12)) | ((((bptr[1] & 63)) << 6))) | ((bptr[2] & 63))))
                            else:
                                if (((c & 8)) == 0):
                                    (c = (((((((c & 7)) << 18)) | ((((bptr[1] & 63)) << 12))) | ((((bptr[2] & 63)) << 6))) | ((bptr[3] & 63))))
                                else:
                                    if (((c & 4)) == 0):
                                        (c = ((((((((c & 3)) << 24)) | ((((bptr[1] & 63)) << 18))) | ((((bptr[2] & 63)) << 12))) | ((((bptr[3] & 63)) << 6))) | ((bptr[4] & 63))))
                                    else:
                                        (c = (((((((((c & 1)) << 30)) | ((((bptr[1] & 63)) << 24))) | ((((bptr[2] & 63)) << 18))) | ((((bptr[3] & 63)) << 12))) | ((((bptr[4] & 63)) << 6))) | ((bptr[5] & 63))))
        ...
        (was_ep_ZWJ = ((if (lgb == ucp_gbExtended_Pictographic) and (rgb == ucp_gbZWJ): 1 else: 0)))
