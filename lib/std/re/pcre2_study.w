                ...
                while true {
                    ...
                    match op__goto_138_15:
                        ...
                        OP_BRA =>
                            ...
                            if ((if cc__goto_116_12[(1 + 2)] == OP_RECURSE: 1 else: 0) != 0) {
                                (__ci_expr_logic_3 = (if (if cc__goto_116_12[(2 * (1 + 2))] == OP_KET: 1 else: 0) != 0: 1 else: 0))
                            }
                        ...
                        OP_CHAR =>
                            ...
                            if (utf != 0) {
                                (__ci_expr_logic_8 = (if (if cc__goto_116_12[-1] >= 192: 1 else: 0) != 0: 1 else: 0))
                            }
                        ...
                        OP_TYPEPLUS =>
                            ...
                            if ((if cc__goto_116_12[1] == OP_PROP: 1 else: 0) != 0) {
                                (__ci_expr_logic_9 = (if true: 1 else: 0))
                            } else {
                                (__ci_expr_logic_9 = (if (if cc__goto_116_12[1] == OP_NOTPROP: 1 else: 0) != 0: 1 else: 0))
                            }
                        ...
                        OP_EXACT =>
                            ...
                            if (utf != 0) {
                                (__ci_expr_logic_11 = (if (if cc__goto_116_12[-1] >= 192: 1 else: 0) != 0: 1 else: 0))
                            }
                        ...
                        OP_TYPEEXACT =>
                            ...
                            if ((if cc__goto_116_12[(1 + 2)] == OP_PROP: 1 else: 0) != 0) {
                                (__ci_expr_logic_12 = (if true: 1 else: 0))
                            } else {
                                (__ci_expr_logic_12 = (if (if cc__goto_116_12[(1 + 2)] == OP_NOTPROP: 1 else: 0) != 0: 1 else: 0))
                            }
                        ...
                        OP_TYPESTAR =>
                            ...
                            if ((if cc__goto_116_12[1] == OP_PROP: 1 else: 0) != 0) {
                                ...
                                (__ci_expr_logic_14 = (if (if cc__goto_116_12[1] == OP_NOTPROP: 1 else: 0) != 0: 1 else: 0))
                            }
                        ...
                        OP_TYPEUPTO =>
                            ...
                            if ((if cc__goto_116_12[(1 + 2)] == OP_PROP: 1 else: 0) != 0) {
                                ...
                                (__ci_expr_logic_15 = (if (if cc__goto_116_12[(1 + 2)] == OP_NOTPROP: 1 else: 0) != 0: 1 else: 0))
                            }
                        ...
                        OP_DNREF =>
                            ...
                            if (__ci_expr_logic_17 != 0) {
                                ...
                                while true {
                                    ...
                                    if ((if recno__goto_137_15 <= backref_cache[0]: 1 else: 0) != 0) {
                                        (__ci_expr_logic_19 = (if (if backref_cache[recno__goto_137_15] >= 0: 1 else: 0) != 0: 1 else: 0))
                                    }
                        ...
                        OP_REF =>
                            ...
                            if ((if recno__goto_137_15 <= backref_cache[0]: 1 else: 0) != 0) {
                                (__ci_expr_logic_22 = (if (if backref_cache[recno__goto_137_15] >= 0: 1 else: 0) != 0: 1 else: 0))
                            }
                        ...
                        OP_UPTO =>
                            ...
                            if (utf != 0) {
                                (__ci_expr_logic_28 = (if (if cc__goto_116_12[-1] >= 192: 1 else: 0) != 0: 1 else: 0))
                            }
...
fn set_type_bits(re: *mut pcre2_real_code_8, cbit_type: c_int, table_limit: c_uint) {
    ...
    while ((if c < 256: 1 else: 0) != 0) {
        if ((if (re.tables[(512 +% (c / 8))] & (1 << (c & 7))) != 0: 1 else: 0) != 0) {
            var buff: [6]u8
...
fn set_nottype_bits(re: *mut pcre2_real_code_8, cbit_type: c_int, table_limit: c_uint) {
    ...
    while ((if c < table_limit: 1 else: 0) != 0) {
        (re.start_bitmap[c] = re.start_bitmap[c] | ((~re.tables[((c +% 512) +% cbit_type)]) as u8))
                ...
                while true {
                    ...
                    while (try_next__goto_1110_8 != 0) {
                        ...
                        match (unsafe: *tcode__goto_1111_14):
                            ...
                            OP_PROP =>
                                if ((if tcode__goto_1111_14[1] != 9: 1 else: 0) != 0) {
                                    return SSB_FAIL
                                }
                                
                                (p__goto_1225_25 = (&_pcre2_ucd_caseless_sets_8[0] as *const c_uint) + ((tcode__goto_1111_14[2] as isize) as usize))
                            ...
                            OP_ASSERT =>
                                ...
                                match (unsafe: *ncode__goto_1119_16):
                                    OP_PROP =>
                                        if ((if ncode__goto_1119_16[1] != 9: 1 else: 0) != 0) {
                                            break
                                        }
                                ...
                                if ((if classmap__goto_1120_20 != null: 1 else: 0) != 0) {
                                    if (utf != 0) {
                                        ...
                                        while ((if c__goto_1096_10 < 16: 1 else: 0) != 0) {
                                            (re.start_bitmap[c__goto_1096_10] = re.start_bitmap[c__goto_1096_10] | classmap__goto_1120_20[c__goto_1096_10])
                                        ...
                                        while ((if c__goto_1096_10 < 256: 1 else: 0) != 0) {
                                            if ((if (classmap__goto_1120_20[(c__goto_1096_10 / 8)] & (1 << (c__goto_1096_10 & 7))) != 0: 1 else: 0) != 0) {
