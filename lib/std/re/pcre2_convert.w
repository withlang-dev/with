...
fn pcre2_pattern_convert_8(__param_pattern: *const u8, __param_plength: c_ulong, options: c_uint, buffptr: *mut *mut u8, bufflenptr: *mut c_ulong, __param_ccontext: *mut pcre2_real_convert_context_8) -> c_int:
    ...
    var use_buffer: *mut u8
    var use_length: c_ulong
    var utf: c_int
    var pattype: c_uint
                        ...
                        match sc
                            ...
                            92 =>
                                ...
                                if extended != 0:
                                    ...
                                    if (if __goto_pending != 0: 1 else: 0) != 0:
                                        break
                            41 =>
                                if (if (if extended != 0: 0 else: 1) != 0 or (if bracount == 0: 1 else: 0) != 0: 1 else: 0) != 0:
                                    __pc = 2
                                    __goto_pending = 1
                                (bracount = bracount - 1)
                                __pc = 1
                            ...
                            42 =>
                                if (if lastspecial != 42: 1 else: 0) != 0:
                                    if (if (if extended != 0: 0 else: 1) != 0 and ((if (if posix_state < 2: 1 else: 0) != 0 or (if lastspecial == 40: 1 else: 0) != 0: 1 else: 0)) != 0: 1 else: 0) != 0:
                                        __pc = 2
                                        __goto_pending = 1
                                    if (if __goto_pending != 0: 1 else: 0) != 0:
                                        break
...
fn convert_glob_write_str(out: *mut pcre2_output_context, __param_length: c_ulong):
    ...
    var out_str: *mut u8
    var output: *mut u8
    var output_end: *const u8
    var output_size: c_ulong
    while true:
...
fn convert_glob_parse_range(from: *mut *const u8, pattern_end: *const u8, out: *mut pcre2_output_context, utf: c_int, separator: u8, with_escape: c_int, escape: u8, no_wildsep: c_int) -> c_int:
    var is_negative: c_int
    var separator_seen: c_int
    var has_prev_c: c_int
    var pattern: *const u8
    var char_start: *const u8
    var c: c_uint
    var prev_c: c_uint
    var len: c_int
    var class_index: c_int
...
fn convert_glob(options: c_uint, __param_pattern: *const u8, plength: c_ulong, utf: c_int, use_buffer: *mut u8, use_length: c_ulong, bufflenptr: *mut c_ulong, dummyrun: c_int, ccontext: *mut pcre2_real_convert_context_8) -> c_int:
    ...
    var pattern_start: *const u8
    var pattern_end: *const u8
    var separator: u8
    var escape: u8
    var c: u8
    var no_wildsep: c_int
    var no_starstar: c_int
    var in_atomic: c_int
    var after_starstar: c_int
    var no_slash_z: c_int
