...
extern var coptable: [173]u8
extern var poptable: [173]u8
type static_assertion_coptable = [1]c_int
type static_assertion_poptable = [1]c_int
extern var toptable1: [14]u8
extern var toptable2: [14]u8
...
fn more_workspace(rwsptr: *mut *mut RWS_anchor, ovecsize: c_uint, mb: *mut dfa_match_block_8) -> c_int:
    var rws: *mut RWS_anchor = null // init: untranslatable
    var new: *mut RWS_anchor = null // init: untranslatable
    if (if rws.next != null: 1 else: 0) != 0:
        (new = rws.next)
    else:
        var newsize: c_uint = 0 // init: untranslatable
        var newsizeK: c_uint = 0 // init: untranslatable
...
fn internal_dfa_match(mb: *mut dfa_match_block_8, this_start_code: *const u8, current_subject: *const u8, start_offset: c_ulong, offsets: *mut c_ulong, offsetcount: c_uint, workspace: *mut c_int, wscount: c_int, rlevel: c_uint, RWS: *mut c_int) -> c_int:
    var current_subject = current_subject
    var offsetcount = offsetcount
    var wscount = wscount
    var rlevel = rlevel
    var RWS = RWS
    ...
    while true:
        match __pc
            0 =>
                ...
                (next_new_state = (new_states = (active_states + (wscount as isize as usize))))
                (new_count = 0)
                if (if (if unsafe: *this_start_code == OP_ASSERTBACK: 1 else: 0) != 0 or (if unsafe: *this_start_code == OP_ASSERTBACK_NOT: 1 else: 0) != 0: 1 else: 0) != 0:
                    var max_back: c_ulong = 0 // init failed
                    var gone_back: c_ulong = 0 // init failed
                    (end_code = this_start_code)
                    while true:
                        var back: c_ulong = 0 // init: untranslatable
                        ...
                        if not ((if unsafe: *end_code == OP_ALT: 1 else: 0) != 0):
                            break
                                        ...
                                        var current_offset: c_ulong = 0 // init failed
                    ...
                    (end_code = this_start_code)
                    while true:
                        var revlen: c_uint = 0 // init: untranslatable
                        var back: c_ulong = 0 // init: untranslatable
                        if (if back <= gone_back: 1 else: 0) != 0:
                            var bstate: c_int = (((((((end_code as usize -% start_code as usize) / sizeof[u8]()) + 1) + 2) + revlen)) as c_int)
                    ...
                    if (if (if rlevel == 1: 1 else: 0) != 0 and (if ((mb.moptions & 64)) != 0: 1 else: 0) != 0: 1 else: 0) != 0:
                        ...
                        var length: c_int = ((1 + 2) + ((if ((if (if (if (if unsafe: *this_start_code == OP_CBRA: 1 else: 0) != 0 or (if unsafe: *this_start_code == OP_SCBRA: 1 else: 0) != 0: 1 else: 0) != 0 or (if unsafe: *this_start_code == OP_CBRAPOS: 1 else: 0) != 0: 1 else: 0) != 0 or (if unsafe: *this_start_code == OP_SCBRAPOS: 1 else: 0) != 0: 1 else: 0)) != 0: 2 else: 0)))
                        while true:
                            (length = (1 + 2))
                            if not ((if unsafe: *end_code == OP_ALT: 1 else: 0) != 0):
                                break
                ...
                while true:
                    ...
                    var partial_newline: c_int = 0 // init: untranslatable
                    var could_continue: c_int = 0 // init: untranslatable
                    ...
                    while (if i < active_count: 1 else: 0) != 0:
                        var current_state: *mut stateblock = null // init: untranslatable
                        var caseless: c_int = 0 // init: untranslatable
                        var code: *const u8 = null // init: untranslatable
                        var codevalue: c_uint = 0 // init: untranslatable
                        var state_offset: c_int = current_state.offset
                        var rrc: c_int = 0
                        var count: c_int = 0
                        if (if state_offset < 0: 1 else: 0) != 0:
                            if (if current_state.data > 0: 1 else: 0) != 0:
                                ...
                                (current_state.offset = (state_offset = (0 - state_offset)))
                        ...
                        if (if (if clen == 0: 1 else: 0) != 0 and (if poptable[codevalue] != 0: 1 else: 0) != 0: 1 else: 0) != 0:
                            (could_continue = 1)

                        if (if coptable[codevalue] > 0: 1 else: 0) != 0:
                            (dlen = 1)
                        ...
                        match codevalue
                            ...
                            87 =>
                                if (if clen > 0: 1 else: 0) != 0:
                                    if (if (if (if (if (if (if d == 12: 1 else: 0) != 0 and (if (ptr + (1 as isize as usize)) >= mb.end_subject: 1 else: 0) != 0: 1 else: 0) != 0 and (if ((mb.moptions & (32))) != 0: 1 else: 0) != 0: 1 else: 0) != 0 and (if mb.nltype == 0: 1 else: 0) != 0: 1 else: 0) != 0 and (if mb.nllen == 2: 1 else: 0) != 0: 1 else: 0) != 0 and (if c == mb.nl[0]: 1 else: 0) != 0: 1 else: 0) != 0:
                            ...
                            32 =>
                                if (if clen > 0: 1 else: 0) != 0:
                                    var otherd: c_uint = 0 // init: untranslatable
                                    (otherd = ((fcc)[d]))
                            ...
                            118 =>
                                                                var rc: c_int = 0
                                var local_workspace: *mut c_int = null
                                var local_offsets: *mut c_ulong = null // init: untranslatable
                                var rws: *mut RWS_anchor = null // init: untranslatable
                                var callpat: *const u8 = null // init: untranslatable
                                var recno: c_uint = 0 // init: untranslatable
                                ...
                                if (if rc > 0: 1 else: 0) != 0:
                                    ...
                                    while (if rc >= 0: 1 else: 0) != 0:
                                        var charcount: c_ulong = 0 // init: untranslatable
                                        rc = rc - 2
                            ...
                            135 =>
                                ...
                                var rws: *mut RWS_anchor = null // init: untranslatable
                                if (if rc >= 0: 1 else: 0) != 0:
                                    var end_subpattern: *const u8 = null // init: untranslatable
                                    var charcount: c_ulong = 0 // init: untranslatable
                                    var next_state_offset: c_int = 0
                                    var repeat_state_offset: c_int = 0
