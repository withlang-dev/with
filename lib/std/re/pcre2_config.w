...
fn pcre2_config_8(what: c_uint, where_: *mut c_void) -> c_int:
    ...
    match what
        ...
        10 =>
            ...
            return (((1 +% ((if (where_ == null): string_len(v) else: _pcre2_strcpy_c8_8((where_ as *mut u8), v))))) as c_int)
            ((unsafe: *((where_ as *mut c_uint))) = 0)
        9 =>
            ((unsafe: *((where_ as *mut c_uint))) = 0)
        11 =>
            var v: *const i8 = ((if (32 == 0): (&"10.48 2025-10-21"[0] as *mut c_char) else: (&"10.48-DEV 2025-10-21"[0] as *mut c_char)) as *const i8)
            return (((1 +% ((if (where_ == null): string_len(v) else: _pcre2_strcpy_c8_8((where_ as *mut u8), v))))) as c_int)
        _ =>
            return (-34)
