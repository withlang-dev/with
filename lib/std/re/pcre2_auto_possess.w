        ...
        if (__ci_expr_logic_0 != 0) {
            ...
            if (__ci_expr_logic_8 != 0) {
                ...
                if (__ci_expr_logic_9 != 0) {
                    (repeat_opcode = code + (((((unsafe: code[1]) as c_int) << 8) | (unsafe: code[(1 + 1)])) as c_uint))
                } else {
        ...
        match c:
            ...
            OP_TYPESTAR | OP_TYPEMINSTAR | OP_TYPEPLUS | OP_TYPEMINPLUS | OP_TYPEQUERY | OP_TYPEMINQUERY | OP_TYPEPOSSTAR | OP_TYPEPOSPLUS | OP_TYPEPOSQUERY =>
                ...
                if ((if (unsafe: code[1]) == OP_PROP: 1 else: 0) != 0) {
                    ...
                    (__ci_expr_logic_12 = (if (if (unsafe: code[1]) == OP_NOTPROP: 1 else: 0) != 0: 1 else: 0))
                }
            ...
            OP_TYPEUPTO | OP_TYPEMINUPTO | OP_TYPEEXACT | OP_TYPEPOSUPTO =>
                ...
                if ((if (unsafe: code[(1 + 2)]) == OP_PROP: 1 else: 0) != 0) {
                    ...
                    (__ci_expr_logic_13 = (if (if (unsafe: code[(1 + 2)]) == OP_NOTPROP: 1 else: 0) != 0: 1 else: 0))
                }
...
fn get_chr_property_list(__param_code: *const u8, utf: c_int, ucp: c_int, fcc: *const u8, list: *mut c_uint) -> *const u8 {
    ...
    match c:
        ...
        OP_CHAR | OP_NOT =>
            ...
            if (__ci_expr_logic_8 != 0) {
                if ((if (chr & 32) == 0: 1 else: 0) != 0) {
                    ...
                    (chr = (((chr & 31) as c_uint) << 6) | ((unsafe: *__ci_expr_old_9) & 63))

                } else {
                    if ((if (chr & 16) == 0: 1 else: 0) != 0) {
                        (chr = ((((chr & 15) as c_uint) << 12) | ((((unsafe: *code) & 63) as c_uint) << 6)) | ((unsafe: code[1]) & 63))

                        (code = code + 2)

                    } else {
                        if ((if (chr & 8) == 0: 1 else: 0) != 0) {
                            (chr = (((((chr & 7) as c_uint) << 18) | ((((unsafe: *code) & 63) as c_uint) << 12)) | ((((unsafe: code[1]) & 63) as c_uint) << 6)) | ((unsafe: code[2]) & 63))

                            (code = code + 3)

                        } else {
                            if ((if (chr & 4) == 0: 1 else: 0) != 0) {
                                (chr = ((((((chr & 3) as c_uint) << 24) | ((((unsafe: *code) & 63) as c_uint) << 18)) | ((((unsafe: code[1]) & 63) as c_uint) << 12)) | ((((unsafe: code[2]) & 63) as c_uint) << 6)) | ((unsafe: code[3]) & 63))

                                (code = code + 4)

                            } else {
                                (chr = (((((((chr & 1) as c_uint) << 30) | ((((unsafe: *code) & 63) as c_uint) << 24)) | ((((unsafe: code[1]) & 63) as c_uint) << 18)) | ((((unsafe: code[2]) & 63) as c_uint) << 12)) | ((((unsafe: code[3]) & 63) as c_uint) << 6)) | ((unsafe: code[4]) & 63))
            ...
            ((unsafe: list[0]) = __ci_expr_ternary_10)
            ...
            if (__ci_expr_logic_12 != 0) {
                if ((if (chr & 32) == 0: 1 else: 0) != 0) {
                    ...
                    (chr = (((chr & 31) as c_uint) << 6) | ((unsafe: *__ci_expr_old_13) & 63))
        ...
        OP_CHARI | OP_NOTI =>
            ...
            ((unsafe: list[0]) = __ci_expr_ternary_19)
        ...
        OP_PROP | OP_NOTPROP =>
            ...
            if (__ci_expr_logic_20 != 0) {
                (end = (code + (((((unsafe: code[0]) as c_int) << 8) | (unsafe: code[(0 + 1)])) as c_uint)) - ((1 as isize) as usize))
            } else {
            ...
            match (unsafe: *end):
                ...
                OP_CRRANGE | OP_CRMINRANGE | OP_CRPOSRANGE =>
                    ((unsafe: list[1]) = (if ((((((unsafe: end[1]) as c_int) << 8) | (unsafe: end[(1 + 1)])) as c_uint)) == 0: 1 else: 0))
    ...
    while true {
        ...
        match c:
            ...
            OP_KET | OP_KETRPOS =>
                ...
                (bracode = code - (((((unsafe: code[1]) as c_int) << 8) | (unsafe: code[(1 + 1)])) as c_uint))
                ...
                match (unsafe: *bracode):
                    ...
                    OP_ASSERTBACK | OP_ASSERTBACK_NOT =>
                        while true {
                            ...
                            (bracode = bracode + (((((unsafe: bracode[1]) as c_int) << 8) | (unsafe: bracode[(1 + 1)])) as c_uint))
                ...
                (next_code = code + (((((unsafe: code[1]) as c_int) << 8) | (unsafe: code[(1 + 1)])) as c_uint))
                ...
                while ((if (unsafe: *next_code) == OP_ALT: 1 else: 0) != 0) {
                    ...
                    (next_code = next_code + (((((unsafe: next_code[1]) as c_int) << 8) | (unsafe: next_code[(1 + 1)])) as c_uint))
            ...
            if ((if list[0] == 29: 1 else: 0) != 0) {
                ...
                if (__ci_expr_logic_6 != 0) {
                    ...
                    if ((if (unsafe: base_list[0]) == 110: 1 else: 0) != 0) {
                        ...
                        if ((if not (utf != 0): 1 else: 0) != 0) {
                            (__ci_expr_logic_7 = (if (if (unsafe: base_list[0]) == 111: 1 else: 0) != 0: 1 else: 0))
                        }
                    ...
                    match (unsafe: list_ptr[0]):
                        ...
                        112 =>
                            ...
                            (xclass_flags = (__ci_expr_ternary_10 - (unsafe: list_ptr[2])) + ((2 as isize) as usize))
                    ...
                    if (__ci_expr_logic_15 != 0) {
                        if ((if rightop == 24: 1 else: 0) != 0) {
                            ...
                            if (__ci_expr_logic_16 != 0) {
                                ...
                                var bothprop: c_int = with 0 as __ci_expr_seq_295 {
                                ...
                                match n:
                                    ...
                                    4 =>
                                        ...
                                        if (risprop != 0) {
                                            (__ci_expr_logic_18 = (if (if catposstab[(unsafe: base_list[3])][list[3]] == same: 1 else: 0) != 0: 1 else: 0))
                                        }
                                    ...
                                    5 =>
                                        ...
                                        if (lisprop != 0) {
                                            (__ci_expr_logic_19 = (if (if catposstab[list[3]][(unsafe: base_list[3])] == same: 1 else: 0) != 0: 1 else: 0))
                                        }
                                    ...
                                    6 | 7 | 8 =>
                                        ...
                                        if (risprop != 0) {
                                            ...
                                            if ((if list[3] != (unsafe: p[0]): 1 else: 0) != 0) {
                                                (__ci_expr_logic_20 = (if (if list[3] != (unsafe: p[1]): 1 else: 0) != 0: 1 else: 0))
                                            }
                                    ...
                                    9 | 10 | 11 =>
                                        ...
                                        if (lisprop != 0) {
                                            ...
                                            if ((if (unsafe: base_list[3]) != (unsafe: p[0]): 1 else: 0) != 0) {
                                                (__ci_expr_logic_24 = (if (if (unsafe: base_list[3]) != (unsafe: p[1]): 1 else: 0) != 0: 1 else: 0))
                                            }
                                    ...
                                    12 | 13 | 14 =>
                                        ...
                                        if (risprop != 0) {
                                            ...
                                            if (catposstab[(unsafe: p[0])][list[3]] != 0) {
                                                (__ci_expr_logic_28 = (if catposstab[(unsafe: p[1])][list[3]] != 0: 1 else: 0))
                                            }
                                    ...
                                    15 | 16 | 17 =>
                                        ...
                                        if (lisprop != 0) {
                                            ...
                                            if (catposstab[(unsafe: p[0])][(unsafe: base_list[3])] != 0) {
                                                (__ci_expr_logic_32 = (if catposstab[(unsafe: p[1])][(unsafe: base_list[3])] != 0: 1 else: 0))
                                            }
        ...
        while true {
            ...
            match (unsafe: list_ptr[0]):
                ...
                7 =>
                    ...
                    if ((if chr < 256: 1 else: 0) != 0) {
                        (__ci_expr_logic_40 = (if (if ((unsafe: cb.ctypes[chr]) & 8) != 0: 1 else: 0) != 0: 1 else: 0))
                    }
                ...
                6 =>
                    ...
                    if ((if chr > 255: 1 else: 0) != 0) {
                        ...
                        (__ci_expr_logic_41 = (if (if ((unsafe: cb.ctypes[chr]) & 8) == 0: 1 else: 0) != 0: 1 else: 0))
                    }
                ...
                9 =>
                    ...
                    if ((if chr < 256: 1 else: 0) != 0) {
                        (__ci_expr_logic_42 = (if (if ((unsafe: cb.ctypes[chr]) & 1) != 0: 1 else: 0) != 0: 1 else: 0))
                    }
                ...
                8 =>
                    ...
                    if ((if chr > 255: 1 else: 0) != 0) {
                        ...
                        (__ci_expr_logic_43 = (if (if ((unsafe: cb.ctypes[chr]) & 1) == 0: 1 else: 0) != 0: 1 else: 0))
                    }
                ...
                11 =>
                    ...
                    if ((if chr < 255: 1 else: 0) != 0) {
                        (__ci_expr_logic_44 = (if (if ((unsafe: cb.ctypes[chr]) & 16) != 0: 1 else: 0) != 0: 1 else: 0))
                    }
                ...
                10 =>
                    ...
                    if ((if chr > 255: 1 else: 0) != 0) {
                        ...
                        (__ci_expr_logic_45 = (if (if ((unsafe: cb.ctypes[chr]) & 16) == 0: 1 else: 0) != 0: 1 else: 0))
                    }
                ...
                111 =>
                    ...
                    (class_bitset = __ci_expr_ternary_46 - (unsafe: list_ptr[2]))


                    if ((if ((unsafe: class_bitset[((chr as c_uint) >> 3)]) & ((1 as c_uint) << (chr & 7))) != 0: 1 else: 0) != 0) {
                        return 0
                    }
                ...
                112 =>
                    ...
                    if (_pcre2_xclass_8(chr, ((__ci_expr_ternary_47 - (unsafe: list_ptr[2])) + ((2 as isize) as usize)), (cb.start_code as *const u8), utf) != 0) {
                        return 0
                    }
                ...
                113 =>
                    ...
                    if (_pcre2_eclass_8(chr, ((__ci_expr_ternary_48 - (unsafe: list_ptr[2])) + ((2 as isize) as usize)), (__ci_expr_ternary_49 - (unsafe: list_ptr[3])), (cb.start_code as *const u8), utf) != 0) {
                        return 0
                    }
