...
extern var autoposstab: [17][21]u8
...
fn get_chr_property_list(code: *const u8, utf: c_int, ucp: c_int, fcc: *const u8, list: *mut c_uint) -> *const u8:
    var code = code
    var c: u8 = 0 // init: untranslatable
    var base: u8 = 0 // init: untranslatable
    var end: *const u8 = null // init: untranslatable
    var class_end: *const u8 = null // init: untranslatable
    var chr: c_uint = 0 // init: untranslatable
    utf
    ucp
    (list[0] = c)
    (list[1] = 0)
...
fn compare_opcodes(code: *const u8, utf: c_int, ucp: c_int, cb: *const compile_block_8, base_list: *const c_uint, base_end: *const u8, rec_limit: *mut c_int) -> c_int:
    var code = code
    var c: u8 = 0 // init: untranslatable
    var list = 0 // init: untranslatable ([8]c_uint)
    var chr_ptr: *const c_uint = null // init: untranslatable
    var ochr_ptr: *const c_uint = null // init: untranslatable
    var list_ptr: *const c_uint = null // init: untranslatable
    var next_code: *const u8 = null // init: untranslatable
    var class_bitset: *const u8 = null // init: untranslatable
    var set1: *const u8 = null // init: untranslatable
    var set2: *const u8 = null // init: untranslatable
    var set_end: *const u8 = null // init: untranslatable
    var chr: c_uint = 0 // init: untranslatable
    var accepted: c_int = 0 // init: untranslatable
    var invert_bits: c_int = 0 // init: untranslatable
    var entered_a_group: c_int = 0 // init: untranslatable
    if (if ((unsafe: *rec_limit) = (unsafe: *rec_limit) - 1) <= 0: 1 else: 0) != 0:
        return 0

    while true:
        var bracode: *const u8 = null // init: untranslatable
        (c = unsafe: *code)
        ...
        if (if base_list[0] == 29: 1 else: 0) != 0:
            ...
            if (if list[0] == 29: 1 else: 0) != 0:
                (chr_ptr = (list + (2 as isize as usize)))
                (list_ptr = base_list)
