...
pub unsafe fn pcre2_regcomp(__param_preg: *mut regex_t, __param_pattern: *const i8, __param_cflags: c_int) -> c_int {
    ...
    ((*__param_preg).re_match_data = null)
    ...
    ((*__param_preg).re_cflags = __param_cflags)

    ((*__param_preg).re_pcre2_code = ((pcre2_compile_8((__param_pattern as *const u8), __local_patlen, (__local_options as c_uint), (&raw mut __local_errorcode as *mut c_int), (&raw mut __local_erroffset as *mut c_ulong), (null as *mut pcre2_real_compile_context_8)) as *mut c_void)))

    ((*__param_preg).re_erroffset = __local_erroffset)
    ...
    pcre2_pattern_info_8(((*__param_preg).re_pcre2_code as *const pcre2_real_code_8), (4 as c_uint), ((&raw mut __local_re_nsub as *mut c_int) as *mut c_void))

    ((*__param_preg).re_nsub = ((__local_re_nsub as c_ulong)))

    ((*__param_preg).re_match_data = ((pcre2_match_data_create_8(((__local_re_nsub + 1) as c_uint), (null as *mut pcre2_real_general_context_8)) as *mut c_void)))

    ((*__param_preg).re_erroffset = ((-1 as c_ulong)))
...
pub unsafe fn pcre2_regexec(__param_preg: *const regex_t, __param_string: *const i8, __param_nmatch: c_ulong, __param_pmatch: *mut regmatch_t, __param_eflags: c_int) -> c_int {
    ...
    if ((if (((*__param_preg).re_cflags as c_int) & (32 as c_int)) != 0: 1 else: 0) != 0) {
        (__ci_expr_logic_0 = (if true: 1 else: 0))
    } else {
        (__ci_expr_logic_0 = (if (if (&(__param_pmatch[0]) as *mut c_void) == null: 1 else: 0) != 0: 1 else: 0))
    }
    ...
    if ((if ((__param_eflags as c_int) & (128 as c_int)) != 0: 1 else: 0) != 0) {
        if ((if (&(__param_pmatch[0]) as *mut c_void) == null: 1 else: 0) != 0) {
            return REG_INVARG
        }

        (__local_so = (__param_pmatch[0]).rm_so)

        (__local_eo = (__param_pmatch[0]).rm_eo)
    ...
    (__local_rc = ((pcre2_match_8(((*__param_preg).re_pcre2_code as *const pcre2_real_code_8), ((__param_string as *const u8) + ((__local_so as isize) as usize)), ((__local_eo - __local_so) as c_ulong), (0 as c_ulong), (__local_options as c_uint), __local_md, (null as *mut pcre2_real_match_context_8)) as c_int)))
    ...
    if ((if __local_rc >= 0: 1 else: 0) != 0) {
        ...
        while ((if __local_i < __local_nmatch: 1 else: 0) != 0) {
            ((__param_pmatch[__local_i]).rm_eo = ((-1 as c_int)))

            ((__param_pmatch[__local_i]).rm_so = (__param_pmatch[__local_i]).rm_eo)
...
pub unsafe fn pcre2_regerror(__param_errcode: c_int, __param_preg: *const regex_t, __param_errbuf: *mut i8, __param_errbuf_size: c_ulong) -> c_ulong {
    ...
    while ((if (*__local_message) != 0: 1 else: 0) != 0) {
        if ((if ((__local_i as c_ulong) +% (1 as c_ulong)) < __param_errbuf_size: 1 else: 0) != 0) {
            ((__param_errbuf[__local_i]) = (*__local_message))
        }
