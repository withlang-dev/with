...
fn pcre2_regcomp(__p0: *mut regex_t, __p1: *const i8, __p2: c_int) -> c_int:
    var preg = __p0
    var pattern = __p1
    var cflags = __p2
...
fn pcre2_regexec(__p0: *const regex_t, __p1: *const i8, __p2: c_ulong, __p3: *mut regmatch_t, __p4: c_int) -> c_int:
    var preg = __p0
    var string = __p1
    var nmatch = __p2
    var pmatch = __p3
...
fn pcre2_regerror(__p0: c_int, __p1: *const regex_t, __p2: *mut i8, __p3: c_ulong) -> c_ulong:
    var errcode = __p0
    var preg = __p1
    var errbuf = __p2
    var errbuf_size = __p3
...
fn pcre2_regfree(__p0: *mut regex_t):
    var preg = __p0
