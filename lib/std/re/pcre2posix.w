...
fn pcre2_regcomp(p0: *mut regex_t, p1: *const i8, p2: c_int) -> c_int:
...
fn pcre2_regexec(p0: *const regex_t, p1: *const i8, p2: c_ulong, p3: *mut regmatch_t, p4: c_int) -> c_int:
    var rc: c_int = 0
    var so: c_int = 0
    var eo: c_int = 0
    var options: c_int = 0
...
(pmatch[i].rm_so = (pmatch[i].rm_eo = (0 - 1)))            { let __tmp = i; i = i + 1; __tmp }
...
fn pcre2_regerror(p0: c_int, p1: *const regex_t, p2: *mut i8, p3: c_ulong) -> c_ulong:
...
fn pcre2_regfree(p0: *mut regex_t):
