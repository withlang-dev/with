...
fn _pcre2_xclass_8(__param_c: c_uint, __param_data: *const u8, char_lists_end: *const u8, __param_utf: c_int) -> c_int {
    ...
    if ((if ((unsafe: *__ci_expr_old_0) & 2) != 0: 1 else: 0) != 0) {
        if ((if c < 256: 1 else: 0) != 0) {
            return (if ((unsafe: data[(c / 8)]) & (1 << (c & 7))) != 0: 1 else: 0)
        }
            ...
            match (unsafe: *data):
                ...
                4 =>
                    ...
                    if ((if (unsafe: data[1]) == prop.script: 1 else: 0) != 0) {
                        ...
                        (__ci_expr_logic_6 = (if (if ((unsafe: ((&_pcre2_ucd_script_sets_8[0] as *const c_uint) + (((prop.scriptx_bidiclass & 1023) as isize) as usize))[((unsafe: data[1]) / 32)]) & (1 << ((unsafe: data[1]) % 32))) != 0: 1 else: 0) != 0: 1 else: 0))
                    }
                ...
                11 =>
                    if ((if (if (prop.scriptx_bidiclass >> 11) == (unsafe: data[1]): 1 else: 0) == isprop: 1 else: 0) != 0) {
                        return not_negated
                    }
                12 =>
                    (ok = (if ((unsafe: ((&_pcre2_ucd_boolprop_sets_8[0] as *const c_uint) + (((prop.bprops & 4095) as isize) as usize))[((unsafe: data[1]) / 32)]) & (1 << ((unsafe: data[1]) % 32))) != 0: 1 else: 0))
            ...
            if (utf != 0) {
                ...
                if ((if x >= 192: 1 else: 0) != 0) {
                    if ((if (x & 32) == 0: 1 else: 0) != 0) {
                        ...
                        (x = ((x & 31) << 6) | ((unsafe: *__ci_expr_old_42) & 63))

                    } else {
                        if ((if (x & 16) == 0: 1 else: 0) != 0) {
                            (x = (((x & 15) << 12) | (((unsafe: *data) & 63) << 6)) | ((unsafe: data[1]) & 63))

                            (data = data + 2)

                        } else {
                            if ((if (x & 8) == 0: 1 else: 0) != 0) {
                                (x = ((((x & 7) << 18) | (((unsafe: *data) & 63) << 12)) | (((unsafe: data[1]) & 63) << 6)) | ((unsafe: data[2]) & 63))

                                (data = data + 3)

                            } else {
                                if ((if (x & 4) == 0: 1 else: 0) != 0) {
                                    (x = (((((x & 3) << 24) | (((unsafe: *data) & 63) << 18)) | (((unsafe: data[1]) & 63) << 12)) | (((unsafe: data[2]) & 63) << 6)) | ((unsafe: data[3]) & 63))

                                    (data = data + 4)

                                } else {
                                    (x = ((((((x & 1) << 30) | (((unsafe: *data) & 63) << 24)) | (((unsafe: data[1]) & 63) << 18)) | (((unsafe: data[2]) & 63) << 12)) | (((unsafe: data[3]) & 63) << 6)) | ((unsafe: data[4]) & 63))
            ...
            if (utf != 0) {
                ...
                if ((if y >= 192: 1 else: 0) != 0) {
                    if ((if (y & 32) == 0: 1 else: 0) != 0) {
                        ...
                        (y = ((y & 31) << 6) | ((unsafe: *__ci_expr_old_46) & 63))

                    } else {
                        if ((if (y & 16) == 0: 1 else: 0) != 0) {
                            (y = (((y & 15) << 12) | (((unsafe: *data) & 63) << 6)) | ((unsafe: data[1]) & 63))

                            (data = data + 2)

                        } else {
                            if ((if (y & 8) == 0: 1 else: 0) != 0) {
                                (y = ((((y & 7) << 18) | (((unsafe: *data) & 63) << 12)) | (((unsafe: data[1]) & 63) << 6)) | ((unsafe: data[2]) & 63))

                                (data = data + 3)

                            } else {
                                if ((if (y & 4) == 0: 1 else: 0) != 0) {
                                    (y = (((((y & 3) << 24) | (((unsafe: *data) & 63) << 18)) | (((unsafe: data[1]) & 63) << 12)) | (((unsafe: data[2]) & 63) << 6)) | ((unsafe: data[3]) & 63))

                                    (data = data + 4)

                                } else {
                                    (y = ((((((y & 1) << 30) | (((unsafe: *data) & 63) << 24)) | (((unsafe: data[1]) & 63) << 18)) | (((unsafe: data[2]) & 63) << 12)) | (((unsafe: data[3]) & 63) << 6)) | ((unsafe: data[4]) & 63))
    ...
    (type_ = (((unsafe: data[0]) << 8) as c_uint) | (unsafe: data[1]))

    (data = data + 2)

    (next_char = char_lists_end - (((((unsafe: data[0]) << 8) | (unsafe: data[(0 + 1)])) as c_uint) << 1))
...
fn _pcre2_eclass_8(c: c_uint, data_start: *const u8, data_end: *const u8, char_lists_end: *const u8, utf: c_int) -> c_int {
    ...
    if ((if (flags & 1) != 0: 1 else: 0) != 0) {
        if ((if c < 256: 1 else: 0) != 0) {
            return (if ((unsafe: ptr[(c / 8)]) & (1 << (c & 7))) != 0: 1 else: 0)
        }
    ...
    while ((if ptr < data_end: 1 else: 0) != 0) {
        match (unsafe: *ptr):
            ...
            5 =>
                ...
                (ptr = ptr + ((((unsafe: ptr[1]) << 8) | (unsafe: ptr[(1 + 1)])) as c_uint))
