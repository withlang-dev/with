...
fn _pcre2_xclass_8(__param_c: c_uint, __param_data: *const u8, char_lists_end: *const u8, __param_utf: c_int) -> c_int {
    ...
    if (__ci_expr_logic_1 != 0) {
        ...
        while true {
            ...
            match (unsafe: *data):
                ...
                1 =>
                    if ((if (if data[1] == _pcre2_ucp_gentype_8[prop.chartype]: 1 else: 0) == isprop: 1 else: 0) != 0) {
                        return not_negated
                    }
                2 =>
                    if ((if (if data[1] == prop.chartype: 1 else: 0) == isprop: 1 else: 0) != 0) {
                        return not_negated
                    }
                3 =>
                    if ((if (if data[1] == prop.script: 1 else: 0) == isprop: 1 else: 0) != 0) {
                        return not_negated
                    }
                4 =>
                    var __ci_expr_logic_6: c_int
                    
                    if ((if data[1] == prop.script: 1 else: 0) != 0) {
                        (__ci_expr_logic_6 = (if true: 1 else: 0))
                    } else {
                        (__ci_expr_logic_6 = (if (if (((&_pcre2_ucd_script_sets_8[0] as *const c_uint) + (((prop.scriptx_bidiclass & 1023) as isize) as usize))[(data[1] / 32)] & (1 << (data[1] % 32))) != 0: 1 else: 0) != 0: 1 else: 0))
                    }
                ...
                11 =>
                    if ((if (if (prop.scriptx_bidiclass >> 11) == data[1]: 1 else: 0) == isprop: 1 else: 0) != 0) {
                        return not_negated
                    }
                12 =>
                    (ok = (if (((&_pcre2_ucd_boolprop_sets_8[0] as *const c_uint) + (((prop.bprops & 4095) as isize) as usize))[(data[1] / 32)] & (1 << (data[1] % 32))) != 0: 1 else: 0))
                ...
                if ((if x >= 192: 1 else: 0) != 0) {
                    if ((if (x & 32) == 0: 1 else: 0) != 0) {
                        ...
                        if ((if (x & 16) == 0: 1 else: 0) != 0) {
                            (x = (((x & 15) << 12) | (((unsafe: *data) & 63) << 6)) | (data[1] & 63))
                            
                            (data = data + 2)
                            
                        } else {
                            if ((if (x & 8) == 0: 1 else: 0) != 0) {
                                (x = ((((x & 7) << 18) | (((unsafe: *data) & 63) << 12)) | ((data[1] & 63) << 6)) | (data[2] & 63))
                                
                                (data = data + 3)
                                
                            } else {
                                if ((if (x & 4) == 0: 1 else: 0) != 0) {
                                    (x = (((((x & 3) << 24) | (((unsafe: *data) & 63) << 18)) | ((data[1] & 63) << 12)) | ((data[2] & 63) << 6)) | (data[3] & 63))
                                    
                                    (data = data + 4)
                                    
                                } else {
                                    (x = ((((((x & 1) << 30) | (((unsafe: *data) & 63) << 24)) | ((data[1] & 63) << 18)) | ((data[2] & 63) << 12)) | ((data[3] & 63) << 6)) | (data[4] & 63))
                ...
                if ((if y >= 192: 1 else: 0) != 0) {
                    if ((if (y & 32) == 0: 1 else: 0) != 0) {
                        ...
                        if ((if (y & 16) == 0: 1 else: 0) != 0) {
                            (y = (((y & 15) << 12) | (((unsafe: *data) & 63) << 6)) | (data[1] & 63))
                            
                            (data = data + 2)
                            
                        } else {
                            if ((if (y & 8) == 0: 1 else: 0) != 0) {
                                (y = ((((y & 7) << 18) | (((unsafe: *data) & 63) << 12)) | ((data[1] & 63) << 6)) | (data[2] & 63))
                                
                                (data = data + 3)
                                
                            } else {
                                if ((if (y & 4) == 0: 1 else: 0) != 0) {
                                    (y = (((((y & 3) << 24) | (((unsafe: *data) & 63) << 18)) | ((data[1] & 63) << 12)) | ((data[2] & 63) << 6)) | (data[3] & 63))
                                    
                                    (data = data + 4)
                                    
                                } else {
                                    (y = ((((((y & 1) << 30) | (((unsafe: *data) & 63) << 24)) | ((data[1] & 63) << 18)) | ((data[2] & 63) << 12)) | ((data[3] & 63) << 6)) | (data[4] & 63))
    ...
    while (1 != 0) {
        ...
        if ((if c < value: 1 else: 0) != 0) {
            ...
            if ((if (next_char as *const c_uint)[(mid_index_1 +% 1)] <= c: 1 else: 0) != 0) {
