...
pub const canonical_modules = [_]ModuleSpec{
    .{ .logical_name = "ast", .file_path = "bootstrap/src/Ast.zig" },
    .{ .logical_name = "types", .file_path = "bootstrap/src/Types.zig" },
    .{ .logical_name = "parse", .file_path = "bootstrap/src/Parse.zig" },
    .{ .logical_name = "check", .file_path = "bootstrap/src/Check.zig" },
    .{ .logical_name = "mir", .file_path = "bootstrap/src/Mir.zig" },
    .{ .logical_name = "codegen", .file_path = "bootstrap/src/Codegen.zig" },
    .{ .logical_name = "driver", .file_path = "bootstrap/src/Driver.zig" },
    .{ .logical_name = "diag", .file_path = "bootstrap/src/Diag.zig" },
};
...
test "scaffold validation rejects duplicate logical module" {
    ...
    specs[7] = .{ .logical_name = "ast", .file_path = "bootstrap/src/Ast.zig" };
...
test "scaffold validation rejects missing module file" {
    var specs = canonical_modules;
    specs[4] = .{ .logical_name = "mir", .file_path = "bootstrap/src/__missing_mir__.zig" };
