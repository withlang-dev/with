...
expect_run_pass "bootstrap/test/cases/derive_eq.w"
expect_run_pass "bootstrap/test/cases/derive_clone.w"
...
expect_check_fail_msg "bootstrap/test/gaps/phase6/p6_derive_copy_ineligible.check_fail.w" "cannot derive Copy"
