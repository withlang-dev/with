...
expect_run_pass "bootstrap/test/cases/comptime_if.w"
expect_run_pass "bootstrap/test/cases/comptime_for.w"
expect_run_pass "bootstrap/test/cases/comptime.w"
expect_run_pass "bootstrap/test/cases/comptime_arith.w"
expect_run_pass "bootstrap/test/cases/comptime_block.w"
