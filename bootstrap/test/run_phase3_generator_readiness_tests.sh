...
expect_run_pass "bootstrap/test/cases/generator.w"
expect_run_pass "bootstrap/test/cases/gen_params.w"
expect_run_pass "bootstrap/test/cases/gen_multi_yield.w"
expect_run_pass "bootstrap/test/cases/gen_fib.w"
expect_run_pass "bootstrap/test/cases/generator_stdlib_ready.w"
