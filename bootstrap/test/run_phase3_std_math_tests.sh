...
expect_run_pass "bootstrap/test/cases/import_std_math.w"
expect_run_pass "bootstrap/test/cases/stdlib_math.w"
expect_run_pass "bootstrap/test/cases/float_math.w"
