...
expect_run_pass "bootstrap/test/cases/dyn_trait.w"
expect_run_pass "bootstrap/test/cases/dyn_dispatch.w"
expect_run_pass "bootstrap/test/cases/dyn_dispatch_multi.w"
expect_run_pass "bootstrap/test/cases/trait_dyn_advanced.w"
expect_run_pass "bootstrap/test/cases/impl_trait_dyn.w"
