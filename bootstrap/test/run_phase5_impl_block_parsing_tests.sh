...
expect_run_pass "bootstrap/test/cases/impl_block.w"
expect_run_pass "bootstrap/test/cases/impl_methods_complex.w"
expect_run_pass "bootstrap/test/cases/impl_static.w"
expect_run_pass "bootstrap/test/cases/trait_impl.w"
