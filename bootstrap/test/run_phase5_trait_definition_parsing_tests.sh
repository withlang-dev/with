...
expect_run_pass "bootstrap/test/cases/trait_default.w"
expect_run_pass "bootstrap/test/cases/trait_default_method.w"
expect_run_pass "bootstrap/test/cases/trait_conform.w"
