...
fn Codegen.is_collection_runtime_intrinsic(self: Codegen, intrinsic: MirIntrinsic) -> bool:
    let _ = self
    if intrinsic == MirIntrinsic.VEC_NEW or intrinsic == MirIntrinsic.VEC_WITH_CAPACITY or intrinsic == MirIntrinsic.VEC_PUSH or intrinsic == MirIntrinsic.VEC_GET or intrinsic == MirIntrinsic.VEC_LEN or intrinsic == MirIntrinsic.VEC_LEN32 or intrinsic == MirIntrinsic.VEC_LEN64 or intrinsic == MirIntrinsic.VEC_ULEN32 or intrinsic == MirIntrinsic.VEC_SET or intrinsic == MirIntrinsic.VEC_REMOVE or intrinsic == MirIntrinsic.VEC_CLEAR or intrinsic == MirIntrinsic.VEC_POP or intrinsic == MirIntrinsic.VEC_ITER or intrinsic == MirIntrinsic.VEC_MAP or intrinsic == MirIntrinsic.VEC_FILTER or intrinsic == MirIntrinsic.VEC_FOLD or intrinsic == MirIntrinsic.VEC_CONTAINS or intrinsic == MirIntrinsic.VEC_JOIN:
        return true
    if intrinsic == MirIntrinsic.MAP_NEW or intrinsic == MirIntrinsic.MAP_INSERT or intrinsic == MirIntrinsic.MAP_GET or intrinsic == MirIntrinsic.MAP_CONTAINS or intrinsic == MirIntrinsic.MAP_LEN or intrinsic == MirIntrinsic.MAP_LEN32 or intrinsic == MirIntrinsic.MAP_LEN64 or intrinsic == MirIntrinsic.MAP_ULEN32 or intrinsic == MirIntrinsic.MAP_REMOVE or intrinsic == MirIntrinsic.MAP_CLEAR or intrinsic == MirIntrinsic.MAP_INCREMENT:
        return true
