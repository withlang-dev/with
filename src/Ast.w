...
const FACADE_CLAUSE_BUFFER: i32 = 24           // [ptr_ref, len_ref, capacity(0|1)]  (`buffer param P len param L` / `buffer param P capacity param L inout`, D64 §16.2b.8)
...
const FACADE_CLAUSE_VARIADIC_CASE: i32 = 27    // [selector_sym, type(node)]  (`case CONST: <type>` beneath a variadic clause)
