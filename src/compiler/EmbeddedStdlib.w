...
pub fn embedded_std_is_module_rel(rel_path: &str) -> bool:
    rel_path.starts_with("std/")

pub fn embedded_std_source(rel_path: &str) -> str:
    embedded_std_source_data(rel_path)

pub fn embedded_std_list_modules() -> str:
...
pub fn embedded_std_resolve_path(rel_path: &str) -> str:
...
pub fn embedded_std_rel_path(path: &str) -> str:
