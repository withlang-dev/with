...
fn main -> i32:
    ...
    var rc = 0
    unsafe:
        rc = x509_parse(&raw mut c as *mut X509Cert, &cert_buf[0] as *const u8, 771)
    print_i32(rc)
    print_i32(c.key_type)
    print_i32(c.sig_alg)
    print_i32(c.key_n_start)
    print_i32(c.key_n_len)
    print_i32(c.key_e_start)
    print_i32(c.key_e_len)
    print_i32(c.sig_start)
    print_i32(c.sig_len)
    print_i32(c.tbs_start)
    print_i32(c.tbs_len)
    0
