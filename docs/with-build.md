...
|-----------------|----------------|
| `make`, `make all`, `make build` | `with build` |
| `make stage1` | `with build :stage1` |
| `make stage2` | `with build :stage2` |
| `make stage3` | `with build :stage3` |
| `make runtime` | `with build :runtime` |
| `make selfcheck`, `make smoke` | `with build :selfcheck` |
| `make test` | `with build :test` |
| `make test-pcre2`, `make regex-test`, `make pcre2-test` | `with build :pcre2-test` |
