//! expect-check-fail: implicit drop of `iter` uses `&db` after `db` is moved (§21.1 Rule 7)

// D51 stage 6: an in-place resource whose init receives a database depends on
