...
fn main:
    var lexer1 = Lexer.init("fn let with match for if else return break continue goto async await unsafe type trait impl use module pub extend var comptime gen in as mut: loop while ephemeral spawn defer error extern enum", 0)
