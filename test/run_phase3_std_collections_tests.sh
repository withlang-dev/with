...
expect_run_pass "test/cases/vec.w"
expect_run_pass "test/cases/vec_push_pop.w"
expect_run_pass "test/cases/vec_methods.w"
expect_run_pass "test/cases/vec_iteration.w"
expect_run_pass "test/cases/vec_map_filter.w"
expect_run_pass "test/cases/hashmap.w"
expect_run_pass "test/cases/hashmap_basic.w"
expect_run_pass "test/cases/hashmap_int.w"
expect_run_pass "test/cases/hashmap_ops.w"
expect_run_pass "test/cases/hashset.w"
expect_run_pass "test/cases/hashset_ops.w"
expect_run_pass "test/cases/hashmap_convenience.w"
