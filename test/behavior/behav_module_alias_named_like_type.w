...
// src/Compilation.w shim hit it five times in Lsp.w). The call now falls
// through when the module declares no extension method of that name, and
// the ordinary path names the unresolved `Comp`.
fn main:
...
")
    ...
    p7_assert_failure_contains(via_alias, "undefined variable", "check p1.w")
