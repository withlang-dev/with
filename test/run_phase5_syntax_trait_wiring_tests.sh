...
expect_run_pass "test/cases/for_iter.w"
...
expect_run_pass "test/cases/option_try.w"
expect_run_pass "test/cases/result_try.w"
...
expect_run_pass "test/cases/display_trait.w"
