...
expect_run_output "test/cases/string_interp.w" $'Hello, World!\nx = 42\nsum = 43'
expect_run_pass "test/cases/string_interp_expr.w"
expect_run_pass "test/cases/string_interp_multi.w"
