...
expect_run_pass "test/cases/trait_multibounds.w"
expect_run_pass "test/cases/multi_trait_bounds.w"
expect_run_pass "test/cases/where_clause.w"
expect_run_pass "test/cases/where_multi_bound.w"
expect_run_pass "test/cases/p5_where_clause.w"
