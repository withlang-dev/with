...
pub let NUM_TEST_VALUES: c_ulong = 100
pub let REMOVE_IDX_1: c_int = 23
pub let REMOVE_IDX_2: c_int = 57
pub let REMOVE_IDX_2_LEN: c_int = 7
pub let REMOVE_IDX_3: c_int = 95
pub let REMOVE_IDX_3_LEN: c_int = 10
pub let REMOVE_IDX_3_REAL_LEN: c_int = 5
pub type Trie = _Trie
