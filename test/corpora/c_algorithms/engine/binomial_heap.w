...
pub unsafe fn binomial_heap_free(__param_heap: *mut _BinomialHeap) -> Unit {
    ...
    alloc_test_free(((unsafe *__param_heap).roots as *mut c_void))
...
pub unsafe fn binomial_heap_insert(__param_heap: *mut _BinomialHeap, __param_value: *mut c_void) -> c_int {
    ...
    (__local_new_tree = ((alloc_test_malloc((sizeof[_BinomialTree]() as c_ulong)) as *mut _BinomialTree)))
...
unsafe fn binomial_tree_unref(__param_tree: *mut _BinomialTree) -> Unit {
    ...
    if ((if (unsafe *__param_tree).refcount == 0: 1 else: 0) != 0) {
        ...
        alloc_test_free(((unsafe *__param_tree).subtrees as *mut c_void))
...
unsafe fn binomial_tree_merge(__param_heap: *mut _BinomialHeap, __param_tree1: *mut _BinomialTree, __param_tree2: *mut _BinomialTree) -> *mut _BinomialTree {
    ...
    ((unsafe *__local_new_tree).subtrees = ((alloc_test_malloc((((sizeof[usize]() as c_ulong) *% (((unsafe *__local_new_tree).order as c_int) as c_ulong)) as c_ulong)) as *mut *mut _BinomialTree)))

    if ((if (unsafe *__local_new_tree).subtrees == null: 1 else: 0) != 0) {
        alloc_test_free((__local_new_tree as *mut c_void))
...
unsafe fn binomial_heap_merge_undo(__param_new_roots: *mut *mut _BinomialTree, __param_count: c_uint) -> Unit {
    ...
    alloc_test_free((__param_new_roots as *mut c_void))
...
unsafe fn binomial_heap_merge(__param_heap: *mut _BinomialHeap, __param_other: *mut _BinomialHeap) -> c_int {
    ...
    (__local_new_roots = ((alloc_test_malloc((((sizeof[usize]() as c_ulong) *% (__local_max as c_ulong)) as c_ulong)) as *mut *mut _BinomialTree)))
