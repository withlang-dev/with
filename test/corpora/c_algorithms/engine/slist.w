...
pub unsafe fn slist_append(__param_list: *mut *mut _SListEntry, __param_data: *mut c_void) -> *mut _SListEntry {
    ...
    ((unsafe *__local_newentry).next = ((null as *mut _SListEntry)))
...
pub unsafe fn slist_set_data(__param_listentry: *mut _SListEntry, __param_data: *mut c_void) -> Unit {
    if ((if __param_listentry != null: 1 else: 0) != 0) {
        ((unsafe *__param_listentry).data = __param_data)
...
pub unsafe fn slist_to_array(__param_list: *mut _SListEntry) -> *mut *mut c_void {
    ...
    (__local_array = ((alloc_test_malloc((((sizeof[usize]() as c_ulong) *% (__local_length as c_ulong)) as c_ulong)) as *mut *mut c_void)))
...
pub unsafe fn slist_remove_entry(__param_list: *mut *mut _SListEntry, __param_entry: *mut _SListEntry) -> c_int {
    ...
    if ((if (unsafe *__param_list) == __param_entry: 1 else: 0) != 0) {
        ...
        while true {
            ...
            if ((if __local_rover != null: 1 else: 0) != 0) {
                (__ci_expr_logic_1 = (if (if (unsafe *__local_rover).next != __param_entry: 1 else: 0) != 0: 1 else: 0))
            }
        ...
        ((unsafe *__local_rover).next = (unsafe *__param_entry).next)
...
pub unsafe fn slist_remove_data(__param_list: *mut *mut _SListEntry, __param_callback: unsafe extern "C" fn(*mut c_void, *mut c_void) -> c_int, __param_data: *mut c_void) -> c_uint {
    ...
    while ((if (unsafe *__local_rover) != null: 1 else: 0) != 0) {
        if ((if __param_callback((unsafe *(unsafe *__local_rover)).data, __param_data) != 0: 1 else: 0) != 0) {
            (__local_next = (unsafe *(unsafe *__local_rover)).next)

            alloc_test_free(((unsafe *__local_rover) as *mut c_void))

            ((unsafe *__local_rover) = __local_next)

            (__local_entries_removed = (__local_entries_removed +% 1))

        } else {
            (__local_rover = (((&raw const (unsafe *(unsafe *__local_rover)).next as *const *mut _SListEntry) as *mut *mut _SListEntry)))
...
pub unsafe fn slist_iterate(__param_list: *mut *mut _SListEntry, __param_iter: *mut _SListIterator) -> Unit {
    ...
    ((unsafe *__param_iter).current = ((null as *mut _SListEntry)))
...
pub unsafe fn slist_iter_next(__param_iter: *mut _SListIterator) -> *mut c_void {
    ...
    if (__ci_expr_logic_0 != 0) {
        ...
        ((unsafe *__param_iter).prev_next = (((&raw const (unsafe *(unsafe *__param_iter).current).next as *const *mut _SListEntry) as *mut *mut _SListEntry)))
...
pub unsafe fn slist_iter_remove(__param_iter: *mut _SListIterator) -> Unit {
    ...
    if (not (__ci_expr_logic_0 != 0)) {
        ...
        alloc_test_free(((unsafe *__param_iter).current as *mut c_void))
...
unsafe fn slist_sort_internal(__param_list: *mut *mut _SListEntry, __param_compare_func: unsafe extern "C" fn(*mut c_void, *mut c_void) -> c_int) -> *mut _SListEntry {
    ...
    if ((if (unsafe *__param_list) == null: 1 else: 0) != 0) {
        ...
        (__ci_expr_logic_0 = (if (if (unsafe *(unsafe *__param_list)).next == null: 1 else: 0) != 0: 1 else: 0))
    }
    ...
    while ((if __local_rover != null: 1 else: 0) != 0) {
        var __local_next: *mut _SListEntry = (unsafe *__local_rover).next
