...
pub unsafe fn arraylist_free(__param_arraylist: *mut _ArrayList) -> Unit {
    if ((if __param_arraylist != null: 1 else: 0) != 0) {
        alloc_test_free(((*__param_arraylist).data as *mut c_void))
...
unsafe fn arraylist_enlarge(__param_arraylist: *mut _ArrayList) -> c_int {
    ...
    (__local_data = ((alloc_test_realloc(((*__param_arraylist).data as *mut c_void), (((sizeof[usize]() as c_ulong) *% (__local_newsize as c_ulong)) as c_ulong)) as *mut *mut c_void)))
