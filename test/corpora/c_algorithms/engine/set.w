...
pub fn set_new(__param_hash_func: unsafe extern "C" fn(*mut c_void) -> c_uint, __param_equal_func: unsafe extern "C" fn(*mut c_void, *mut c_void) -> c_int) -> *mut _Set {
    ...
    if ((if not (unsafe { set_allocate_table(__local_new_set) } != 0): 1 else: 0) != 0) {
        unsafe { alloc_test_free((__local_new_set as *mut c_void)) }
...
pub unsafe fn set_free(__param_set: *mut _Set) -> Unit {
    ...
    alloc_test_free(((unsafe *__param_set).table as *mut c_void))

    alloc_test_free((__param_set as *mut c_void))
...
pub unsafe fn set_insert(__param_set: *mut _Set, __param_data: *mut c_void) -> c_int {
    ...
    (__local_newentry = ((alloc_test_malloc((sizeof[_SetEntry]() as c_ulong)) as *mut _SetEntry)))
...
pub unsafe fn set_to_array(__param_set: *mut _Set) -> *mut *mut c_void {
    ...
    (__local_array = ((alloc_test_malloc((((sizeof[usize]() as c_ulong) *% ((unsafe *__param_set).entries as c_ulong)) as c_ulong)) as *mut *mut c_void)))
...
unsafe fn set_allocate_table(__param_set: *mut _Set) -> c_int {
    ...
    ((unsafe *__param_set).table = ((alloc_test_calloc(((unsafe *__param_set).table_size as c_ulong), (sizeof[usize]() as c_ulong)) as *mut *mut _SetEntry)))
