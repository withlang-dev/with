...
pub unsafe fn hash_table_free(__param_hash_table: *mut _HashTable) -> Unit {
    ...
    alloc_test_free(((*__param_hash_table).table as *mut c_void))
...
unsafe fn hash_table_allocate_table(__param_hash_table: *mut _HashTable) -> c_int {
    ...
    ((*__param_hash_table).table = ((alloc_test_calloc(((*__param_hash_table).table_size as c_ulong), (sizeof[usize]() as c_ulong)) as *mut *mut _HashTableEntry)))
