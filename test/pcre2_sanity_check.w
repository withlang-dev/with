...
fn main():
    ...
    var errcode: i32 = 0
    var erroffset: u64 = 0
    let code = pcre2_compile_8(pattern as *const u8, pattern.len() as u64, 0, &mut errcode, &mut erroffset, null)
    if code == null:
    ...
    if md == null:
        ...
        return
    let rc = pcre2_match_8(code, subject as *const u8, subject.len() as u64, 0, 0, md, null)
    if rc < 0:
