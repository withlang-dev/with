...
pub fn build(b: Build) -> Build:
    ...
    var cli_selfhost_one_liner_tests = target_new(30 as BuildKind, "cli-selfhost-one-liner-tests", "out/bin/with-stage2")
    ...
    var cli_selfhost_build_w_tests = target_new(32 as BuildKind, "cli-selfhost-build-w-tests", "out/bin/with-stage2")
    ...
    var cli_selfhost_project_tests = target_new(35 as BuildKind, "cli-selfhost-project-tests", "out/bin/with-stage2")
    ...
    var cli_selfhost_regex_prep_tests = target_new(37 as BuildKind, "cli-selfhost-regex-prep-tests", "out/bin/with-stage2")
    ...
    var cli_selfhost_migrate_basic_tests = target_new(38 as BuildKind, "cli-selfhost-migrate-basic-tests", "out/bin/with-stage2")
