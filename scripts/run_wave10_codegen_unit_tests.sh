...
expect_build_pass "test/behavior/issue61_query_state_stress.w"
expect_build_pass "test/behavior/issue61_query_feature_matrix.w"
expect_build_pass "test/behavior/issue61_query_method_cache_keys.w"
expect_build_pass "test/behavior/issue61_query_string_lifetime_stress.w"
...
expect_run_pass "test/behavior/issue61_query_state_stress.w"
expect_run_pass "test/behavior/issue61_query_feature_matrix.w"
expect_run_pass "test/behavior/issue61_query_order_independent.w"
expect_run_pass "test/behavior/issue61_query_method_cache_keys.w"
expect_run_pass "test/behavior/issue61_query_string_lifetime_stress.w"
expect_run_pass "test/behavior/issue61_query_local_vs_imported_equivalence.w"
