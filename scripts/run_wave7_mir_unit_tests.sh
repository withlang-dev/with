...
run_expect_pattern "issue61_imported_query_matrix" "test/behavior/issue61_query_feature_matrix_dump_mir.w" "call |switchInt\\("
run_expect_pattern "issue61_selfhost_main_mir" "src/main.w" "^mir module functions="
...
run_determinism_check "determinism_issue61_query_matrix" "test/behavior/issue61_query_feature_matrix_dump_mir.w"
