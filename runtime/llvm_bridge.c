...
WL_BINOP(build_nsw_add, LLVMBuildNSWAdd)
WL_BINOP(build_nsw_sub, LLVMBuildNSWSub)
WL_BINOP(build_nsw_mul, LLVMBuildNSWMul)
...
WL_CAST(build_ui_to_fp, LLVMBuildUIToFP)
WL_CAST(build_fp_to_si, LLVMBuildFPToSI)
WL_CAST(build_fp_to_ui, LLVMBuildFPToUI)
