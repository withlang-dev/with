...
c facade libsystem:
    ...
    fn rt_libc_kill
        preserves domain environ
        preserves domain locale
    fn rt_libc_pthread_attr_init
        preserves domain environ
        preserves domain locale
    fn rt_libc_pthread_attr_setstacksize
        preserves domain environ
        preserves domain locale
    fn rt_libc_pthread_attr_destroy
        preserves domain environ
        preserves domain locale
